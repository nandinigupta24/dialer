<div class="panel pn">
    <div class="panel-heading">
        <span class="panel-title"><i class="fa fa-code-fork"></i> Web Form Setting </span>
    </div>
    <div class="panel-body pn">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-12">
                    <button type="button" class="btn btn-sm btn-toggle manage-field-switch <?php echo ($CampaignDetail['web_form_target'] == '_blank') ? 'active' : ''; ?>" data-name="web_form_target" data-id="<?php echo $CampaignDetail['campaign_id']; ?>" id="web_form_target_btn" data-val="<?php echo $CampaignDetail['web_form_target']; ?>" data-y="Y" data-n="" data-input="web_form_target" data-toggle="button" aria-pressed="true" autocomplete="off">
        ...
        <div class="form-group">
            <div class="row">
                <label class="col-md-12" for="open_window_btn">Open on call connect(<span class="text-success">auto pop this script when call connects</span>):</label>
                <div class="col-md-12">
                    <button type="button" class="btn btn-sm btn-toggle manage-field-switch <?php echo ($CampaignDetail['get_call_launch'] == 'WEBFORM') ? 'active' : ''; ?>"  id="open_call_coonect_btn" data-name="get_call_launch" data-input="open_call_coonect" data-id="<?php echo $CampaignDetail['campaign_id']; ?>" data-toggle="button" aria-pressed="true" autocomplete="off">
                        <div class="handle"></div>
                    </button>
