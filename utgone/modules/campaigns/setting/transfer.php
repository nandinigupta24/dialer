<div class="box ">
    <div class="box-header with-border ">
        ...
        <div class="box-tools pull-right">					
            <ul class="box-controls" style="border-left: 1px solid green;">
                <li><a class="box-icon" href="#" data-campaign="<?php echo $CampaignDetail['campaign_id']; ?>" id="addPreSetsBtn" style="color: green;font-size: 21px;"><i class="fa fa-plus"></i></a></li>
            </ul>
        </div>
    </div>
    <div class="box-body">
        ...
        <div class="box box-outline-secondary">
            <div class="box-header with-border">
                <h4 class="box-title"><a  href="#" class="box-icon"><i class="fa fa-exchange"></i></a> Transfer Presets</h4>
            </div>

            <div class="box-body" style="padding: 2px 2px;">
                <div class="">
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="table-responsive">
                                <table class="table table-bordered"> 
                                    <thead>
                                        <tr>
                                            <th style="font-weight: 600;padding: 4px 2px;text-align: center;">Name</th>
                                            <th style="font-weight: 600;padding: 4px 2px;text-align: center;">Number</th>
                                            <th style="font-weight: 600;padding: 4px 2px;text-align: center;">Hide Preset Number</th>
                                            <th style="font-weight: 600;padding: 4px 2px;text-align: center;"></th> 
                                        </tr>
                                    </thead>
