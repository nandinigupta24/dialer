...
<html lang="en">
    <head>
        ...
        <title>UTGONE - Page Not Found </title>
    ...
    <body class="hold-transition">
        ...
        <section class="bg-img h-p100" style="background-image: url(../../assets/images/photo4.jpg);">
                ...
                <div class="row h-p100 align-items-center justify-content-center">
                    <div class="col-lg-8 col-11">		  
                                ...
                                <div class="row h-p100 align-items-center bg-brick-dark bg-dark">
                                    <div class="col-lg-6 col-md-12 bg-white text-dark">
                                        <div class="p-30">							
                                            ...
                                            <p>Quisque sit amet odio sit amet nulla finibus commodo. Sed dictum accumsan vestibulum. Mauris ac sem quis augue. </p>
                                            <div class="mb-15">
                                                <a href="../admin_development.php" class="btn btn-info btn-block margin-top-10">Back to dashboard</a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <footer class="main-footer bg-transparent text-white ml-0 text-center no-border">
                            Copyright © <?php echo date('Y');?>  <a href="https://www.utgone.com/" target="_blank">UTGONE</a>. All Rights Reserved..
                        </footer>
                    </div>
                </div>
            </div>
