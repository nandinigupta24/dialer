    ...
    <section class="content">
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title"><i class="fa fa-list-alt"></i> Outbound Call Log Report</span>
...
<script>
    $(function () {
        ...
        var dt = $('#table-list-campaigns').DataTable({
            ...
            "pageLength": 25,
            "ajax": {
                "url": '<?php echo base_url('outbound/ajax'); ?>?rule=outbound',
                "type": "POST",
            },
        ...
        $('#daterange-btn').daterangepicker(
                ...
                function (start, end) {
                    ...
                    var dt = $('#table-list-campaigns').DataTable({
                        ...
                        "pageLength": 25,
                        "ajax": {
                            "url": '<?php echo base_url('outbound/ajax'); ?>?rule=outbound&start=' + start + '&end=' + end,
                            "type": "POST",
                        },
