...
$query = "SELECT * FROM vicidial_closer_log VCL JOIN vicidial_list VL ON VL.lead_id=VCL.lead_id WHERE VCL.comments='EMAIL' AND VCL.call_date BETWEEN '".$start." 00:00:00' AND '".$end." 23:59:59' AND campaign_id IN ('".implode("','",$_SESSION['CurrentLogin']['CampaignID'])."')";
                ...
                <div class="box">
                    <div class="with-border">
                        <div class="panel-heading">
                            <div class="panel-title"> <span class="fa fa-envelope-o"></span>Email Listings</div>
                            <ul class="nav panel-tabs">
                                <li> 
                                    <a type="button" id="daterange-btn" style="cursor:pointer;">
                                        <span>
...
<?php foreach ($data as $listings) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $listings['email']; ?></td>
                                            <td>
                                                <a href="<?php echo base_url('email/detail') . '?lead_id=' . $listings['lead_id'] . '&U_ID=' . $listings['uniqueid']; ?>" class="btn btn-success" title="Detail View"><i class="fa fa-list-alt"></i></a>
                                            </td>
                                        </tr>
<?php } ?>
                                </tbody>
...
<script>
    ...
    $('#daterange-btn').daterangepicker(
            ...
            function (start, end) {
                ...
                window.location.href = "<?php echo base_url('email/listings') ?>?start=" + start + "&end=" + end;
            }
    );
