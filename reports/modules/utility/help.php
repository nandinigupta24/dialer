                ...
                <div class="box">
                    <div class="with-border">
                        <div class="panel-heading">
                            <div class="panel-title"> <span class="fa fa-question-circle"></span>Help Page</div>
...
<BR/>
<BR/>
<strong style="font-weight:700;"><?php echo _QXZ("User ID"); ?> -</strong><?php echo _QXZ("This field is where you put the users ID number, can be up to 8 digits in length, Must be at least 2 characters in length."); ?>

<BR/>
<BR/>
<strong style="font-weight:700;"><?php echo _QXZ("Password"); ?> -</strong><?php echo _QXZ("This field is where you put the users password. Must be at least 2 characters in length. A medium strength user password will be at least 10 characters in length, and a strong user password will be at least 20 characters in length and have letters as well as at least one number. It is recommended that you use a longer password if possible, stringing together several unrelated words with no spaces, and a number somewhere in the string. The maximum size of a password is 100 characters."); ?>

<BR/>
<BR/>
<strong style="font-weight:700;"><?php echo _QXZ("Force Change Password"); ?> -</strong><?php echo _QXZ("If this option is set to Y then the user will be prompted to change their password the next time they log in to the administration webpage. Default is N."); ?>

<BR/>
<BR/>
<strong style="font-weight:700;"><?php echo _QXZ("Last Login Info"); ?> -</strong><?php echo _QXZ("This shows the last login attempt date and time, and if there has been a recent failed login attempt. If this modify user form is submitted, then the failed login attempt counter will be reset and the agent can immediately attempt to log in again. If an agent has 10 failed login attempts in a row then they cannot attempt to log in again for at least 15 minutes unless their account is manually reset."); ?>

<BR/>
<BR/>
<strong style="font-weight:700;"><?php echo _QXZ("Full Name"); ?> -</strong><?php echo _QXZ("This field is where you put the users full name. Must be at least 2 characters in length."); ?>

<BR/>
<BR/>
<strong style="font-weight:700;"><?php echo _QXZ("User Level"); ?> -</strong><?php echo _QXZ("This menu is where you select the users user level. Must be a level of 1 to log into the agent screen, Must be level greater than 2 to log in as a closer, Must be user level 8 or greater to get into admin web section."); ?>

<BR/>
<BR/>
<strong style="font-weight:700;"><?php echo _QXZ("User Group"); ?> -</strong><?php echo _QXZ("This menu is where you select the users group that this user will belong to. There are several agent screen features that can be controlled through user group settings. If this field is left blank then the user cannot log in to the agent screen."); ?>

<br/><br/>
<strong style="font-weight:700;"><?php echo _QXZ("Phone Login"); ?> -</strong><?php echo _QXZ("Here is where you can set a default phone login value for when the user logs into the agent screen. This value will populate the phone_login automatically when the user logs in with their user-pass-campaign in the agent login screen."); ?>

<br/><br/>
<strong style="font-weight:700;"><?php echo _QXZ("Phone Pass"); ?> -</strong><?php echo _QXZ("Here is where you can set a default phone pass value for when the user logs into the agent screen. This value will populate the phone_pass automatically when the user logs in with their user-pass-campaign in the agent login screen."); ?>

<br/><br/>
<strong style="font-weight:700;"><?php echo _QXZ("Active"); ?> -</strong><?php echo _QXZ("This field defines whether the user is active in the system and can log in as an agent or manager. Default is Y."); ?>

<br/><br/>
<strong style="font-weight:700;"><?php echo _QXZ("Voicemail ID"); ?> -</strong><?php echo _QXZ("This is the voicemail box that calls will be directed to in an AGENTDIRECT in-group at the drop time if the in-group has the drop method set to VOICEMAIL and the Voicemail field set to AGENTVMAIL."); ?>

<br/><br/>
<strong style="font-weight:700;"><?php echo _QXZ("Email, User Code and Territory"); ?> -</strong><?php echo _QXZ("These are optional fields."); ?>

<br/><br/>
<strong style="font-weight:700;"><?php echo _QXZ("User Nickname"); ?> -</strong><?php echo _QXZ("Optional alternative name used for agent when chatting with customers in the customer website chat feature. Only used if populated."); ?>
