    ...
    <section class="content">
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title"><i class="fa fa-list-alt"></i> Agent Hourly Talk Report</span>
    ...
    $(function () {
        ...
        $('#daterange-btn').daterangepicker(
                ...
                function (start, end) {
                    ...
                    window.location.href = "<?php echo base_url('agent/hour_talk'); ?>?start=" + start + "&end=" + end;
                }
        );
    })
