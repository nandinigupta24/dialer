                ...
                <div class="box">
                    <div class="with-border">
                        <div class="panel-heading">
                            <div class="panel-title"> <span class="fa fa-book"></span>RealTime Report</div>
                            <ul class="nav panel-tabs">
                                <li><a href=""><i class="fa fa-refresh" title="Refersh"></i></a></li>
                                <li><a href="" data-toggle="modal" data-target="#ArchiveRuleModel" title="Reeport Setting"><i class="fa fa-cogs text-blue3"></i></a></li>
                            ...
                            // function to gather calls and agents statistical content
                                function gather_realtime_content()
                                {
                                    ...
                                    if (xmlhttp)
                                    {
                                        ...
                                        xmlhttp.open('POST', '<?php echo base_url('test/ajax'); ?>');
                                        xmlhttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');
