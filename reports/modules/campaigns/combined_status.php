<div class="content-wrapper">
    ...
    <section class="content">
        ...
        $data = $database->query("select a.campaign_id,group_concat(a.status) as nameStatus,group_concat(a.count) as countStatus,VC.campaign_name
from (SELECT campaign_id,status,count(*) as count FROM asterisk.vicidial_agent_log where event_time BETWEEN '" . $start . " 00:00:00' AND '" . $end . " 23:59:59' AND status != '' group by campaign_id,status) a  JOIN vicidial_campaigns VC ON a.campaign_id=VC.campaign_id ".get_validation('campaign','VC','WHERE',$database)." group by a.campaign_id")->fetchAll(PDO::FETCH_ASSOC);

        ?>
        <!-- Default box -->
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title"><i class="fa fa-list-alt"></i> Campaign Status Combined Report</span>
    ...
    $(function () {
        ...
        $('#daterange-btn').daterangepicker(
                ...
                function (start, end) {
                    ...
                    window.location.href = "<?php echo base_url('campaigns/combined_status');?>?start=" + start + "&end=" + end;
                }
        );
    })
