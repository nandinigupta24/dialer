    ...
    <section class="content">
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title"><i class="fa fa-list-alt"></i> Campaigns Outbound Summary Report</span>
...
<script>
    $(function () {
		...
		buttons: [
            ...
            "pageLength": 25,
            "ajax": {
                "url": '<?php echo base_url('campaigns/ajax');?>?rule=OutboundSummary',
                "type": "POST",
            },
    ...
    $('#daterange-btn').daterangepicker(
      ...
      function (start, end) {
		...
		buttons: [
            ...
            "pageLength": 25,
            "ajax": {
                "url": '<?php echo base_url('campaigns/ajax');?>?rule=OutboundSummary&start='+start+'&end='+end,
                "type": "POST",
            },
