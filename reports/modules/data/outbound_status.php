...
from (SELECT list_id,status,count(*) as count FROM asterisk.vicidial_log where call_date BETWEEN '".$start." 00:00:00' AND '".$end." 23:59:59' group by list_id,status) a
JOIN vicidial_lists VC ON a.list_id=VC.list_id ".get_validation('list','VC','AND',$database)." group by a.list_id")->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title"><i class="fa fa-list-alt"></i> Data Outbound Status Report</span>
...
//        });
        ...
        $('#daterange-btn').daterangepicker(
                ...
                function (start, end) {
                    ...
                    window.location.href = "<?php echo base_url('data/outbound_status');?>?start=" + start + "&end=" + end;
                }
        );
    })
