        ...
        <script language="Javascript">
            ...
            function send_monitor(session_id, server_ip, stage)
            {
                ...
                if (xmlhttp)
                {
                    ...
                    xmlhttp.open('POST', '<?php echo $baseURL;?>admin/non_agent_api.php');
