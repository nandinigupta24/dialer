                ...
                <div class="col-md-12 col-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="monitor_active_new" name='monitor_active_new' placeholder="Select a Monitor" required="">
                            ...
                            <option value="WHISPER" <?php echo (!empty($_GET['monitor_active']) && $_GET['monitor_active'] =='WHISPER' )? 'selected="selected"':'';?>>WHISPER</option>
                            <!--<option value="ALL" <?php echo (!empty($_GET['monitor_active']) && $_GET['monitor_active'] =='ALL' )? 'selected="selected"':'';?>>WHISPER</option>-->
                        </select>
                    </div>
                </div>
                <div class="col-md-12 col-12">
