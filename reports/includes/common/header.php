<html>
    ...
    <link rel="stylesheet" href="<?php echo publicAssest(); ?>assets/vendor_components/morris.js/morris.css"/>
        ...
        <?php if ($pathUrl[0] == 'dashboard') { ?>
            <!-- jQuery 3 -->
            <script src="<?php echo publicAssest(); ?>assets/vendor_components/jquery/dist/jquery.js"></script>

            <!-- jQuery UI 1.11.4 -->
            <script src="<?php echo publicAssest(); ?>assets/vendor_components/jquery-ui/jquery-ui.js"></script>
            ...
            <!-- Bootstrap 4.0-->
            <script src="<?php echo publicAssest(); ?>assets/vendor_components/bootstrap/dist/js/bootstrap.js"></script>	

            <!-- ChartJS -->
            <script src="<?php echo publicAssest(); ?>assets/vendor_components/chart.js-master/Chart.min.js"></script>

            <!-- Slimscroll -->
            <script src="<?php echo publicAssest(); ?>assets/vendor_components/jquery-slimscroll/jquery.slimscroll.js"></script>

            <!-- FastClick -->
            <script src="<?php echo publicAssest(); ?>assets/vendor_components/fastclick/lib/fastclick.js"></script>

            <!-- peity -->
            <script src="<?php echo publicAssest(); ?>assets/vendor_components/jquery.peity/jquery.peity.js"></script>

            <!-- Morris.js charts -->
            <script src="<?php echo publicAssest(); ?>assets/vendor_components/raphael/raphael.min.js"></script>
            <script src="<?php echo publicAssest(); ?>assets/vendor_components/morris.js/morris.min.js"></script>

            <!-- Fab Admin App -->
            <script src="<?php echo publicAssest(); ?>assets/js/template.js"></script>

            <!-- Fab Admin dashboard demo (This is only for demo purposes) -->
            <script src="<?php echo publicAssest(); ?>assets/js/pages/dashboard_1.js"></script>

            <!-- Fab Admin for demo purposes -->
            <script src="<?php echo publicAssest(); ?>assets/js/demo.js"></script>	

            <!-- Vector map JavaScript -->
            <script src="<?php echo publicAssest(); ?>assets/vendor_components/jvectormap/lib2/jquery-jvectormap-2.0.2.min.js"></script>
            <script src="<?php echo publicAssest(); ?>assets/vendor_components/jvectormap/lib2/jquery-jvectormap-world-mill-en.js"></script>
            <script src="<?php echo publicAssest(); ?>assets/vendor_components/jvectormap/lib2/jquery-jvectormap-us-aea-en.js"></script>
        <?php } else { ?>
