<script language="Javascript">
        var DTMFKeypad = '<?php echo $DTMFKeypad;?>';
	var StatusMan = '';
							...
							if (PausENotifYCounTer > 10)
								...
								PausENotifYCounTer=0;
                                                ...
                                                if(VLAStatuS == 'INCALL'){
                                                    ...
                                                    if($('#WebformONCall iframe').attr('src')){
...
//                                                                    Performance Detail
                                                                $.ajax({
                                                                        ...
                                                                        data: {rule: 'DashboardPerformance','VD_login':user,'VD_campaign':campaign},
...
//                                                                console.log(newRAlocationHTML);
							...
							else
								{
                                                                if(RAlocation == 'AgentSectionDiv'){
                                                                    document.getElementById(RAlocation).innerHTML = '<table class="table table-striped">'+newRAlocationHTML+'</table>';
                                                                }else{
                                                                    document.getElementById(RAlocation).innerHTML = newRAlocationHTML + "\n";
                                                                }
								}
