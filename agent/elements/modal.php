...
<style>
    ...
    .bg_header_background{
        background-color:#4eb598 !important;
        color:#fff !important;
    }
</style>
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
echo $zi ?>;display:none;" id="Header">
...
<span style="z-index:<?php $zi++;
echo $zi ?>; display:none; " id="WelcomeBoxA">
...
<span style="position:absolute;left:350px;top:700px;z-index:<?php $zi++;
echo $zi ?>;display:none;" id="debugbottomspan"></span>


<span style="position:absolute;left:550px;top:<?php echo $CBheight ?>px;z-index:<?php $zi++;
                    echo $zi ?>; display:none;" id="PauseCodeButtons"><font class="body_text">
...
<span style="position:absolute;left:<?php echo $PDwidth ?>px;top:<?php echo $AMheight ?>px;z-index:<?php $zi++;
      echo $zi
      ?>;" id="AgentMuteANDPreseTDiaL"><font class="body_text">
    <?php
...
<span style="position:absolute;left:350px;top:500px;min-width:400px;overflow:scroll;z-index:<?php $zi++;
    echo $zi
    ?>;background-color:<?php echo $SIDEBAR_COLOR ?>;" id="callsinqueuedisplay"><table cellpadding="0" cellspacing="0" border="0"><tr><td width="5px" rowspan="2">&nbsp;</td><td align="center"><font class="body_text"><?php echo _QXZ("Calls In Queue:"); ?> &nbsp; </font></td></tr><tr><td align="center"><span id="callsinqueuelist">&nbsp;</span></td></tr></table></span>

<span style="position:absolute;left:<?php echo $CLwidth ?>px;top:<?php echo $QLheight ?>px;z-index:<?php $zi++;
    echo $zi ?>;display:none;" id="callsinqueuelink">
      <?php
...
<span style="position:absolute;left:300px;top:<?php echo $CBheight ?>px;z-index:<?php $zi++;
      echo $zi ?>;visibility:hidden;" id="CallbacksButtonsOLD">
...
<span style="position:absolute;left:140px;top:650px;z-index:<?php $zi++;
    echo $zi ?>;" id="AgentMuteSpanOLD"></span>
<span style="position:absolute;left:<?php echo $AMwidth ?>px;top:<?php echo $SRheight ?>px;z-index:<?php $zi++;
    echo $zi ?>;display:none;" id="MainCommit">
...
<span style="position:absolute;left:<?php $tempAMwidth = ($AMwidth - 15);
    ...
    <span style=" display:none; position:absolute;left:<?php echo $HKwidth ?>px;top:<?php echo $HKheight ?>px;z-index:<?php $zi++;
                                    echo $zi
                                    ?>;" id="hotkeysdisplay"><a href="#" onMouseOver="HotKeys('ON')"><img src="./images/<?php echo _QXZ("vdc_XB_hotkeysactive_OFF.gif"); ?>" border="0" alt="HOT KEYS INACTIVE" /></a></span>
<?php } ?>
...
?>
                                ...
                                <td>
                                    <span id="dialoverride_checkbox_OLD"><input type="checkbox" class="filled-in chk-col-blue-grey" name="xferoverride_OLD" id="xferoverride_OLD" size="1" value="0"><font class="body_tiny" ><label for="xferoverride">DIAL OVERRIDE</label><?php
...
echo $zi
?>;background-color:<?php echo $SIDEBAR_COLOR ?>;" id="AgentXferViewSpan"><center><font class="body_text">
...
<span style="position:absolute;left:0px;bottom:10%;z-index:9999999999;visibility:hidden" id="NoneInSessionBox">
    <div class="container text-center">
        <!--<div class="lead-OLD"><?php // echo _QXZ("No one is in your session:");  ?><span id="NoneInSessionID-OLD"></span></div>-->
        ...
        <div class="button-place">
            ...
            <br/>
            <span id="NoneInSessionLink"><a href="#" onclick="NoneInSessionCalL();return false;" class="btn btn-default btn-app">Call Phone Again</a></span>
        </div>
    </div>
</span>
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
      echo $zi
?>;width:100%;height:100%;background-color:#e9e9e9;" id="WrapupBox">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
      echo $zi
?>;width:100%;height:100%;background-color:#e9e9e9;" id="FSCREENWrapupBox"><table border="0"  width="<?php echo $CAwidth ?>px" height="<?php echo $WRheight ?>px" cellpadding="0" cellspacing="0"><tr><td><span id="FSCREENWrapupMessage"><?php echo $wrapup_message ?></span></td></tr></table></span>

<span class="text-center" style="position:absolute;left:350px;top:175px;z-index:<?php $zi++;
      echo $zi ?>;width:400px" id="TimerSpan">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
      echo $zi ?>;width:100%;height:100%;background-color:#e9e9e9;" id="SysteMDisablEBoX">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
      echo $zi ?>;width:100%;height:100%;background-color:#e9e9e9;display:none;" id="LogouTBoxOLD">
    <div class="container text-center">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
      echo $zi
?>;width:100%;height:100%;" id="DispoButtonHideC">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
      echo $zi ?>;width:100%;height:100%;background-color:#e9e9e9;visibility:hidden;display:none;" id="DispoSelectBox">
                ...
                <div class="body table-responsive"><center>
                        ...
                        <table class="table">
                            <tr><td align="center"><input type="hidden" name="DispoSelection" id="DispoSelection" /><br />
                                    <input type="checkbox" name="DispoSelectStop" class="filled-in chk-col-blue-grey DispoSelectStop-NEW" id="DispoSelectStop" size="1" value="0" /><label for="DispoSelectStop" data-labelfor="DispoSelectStop">PAUSE AGENT DIALING</label><br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!--<input type="hidden" name="CallBackOnlyMe" class="filled-in" id="CallBackOnlyMeOK" value="0">-->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control pull-right" id="customer_phone">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
...
<?php if ($agentonly_callbacks) { ?>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <button type="button" class="btn btn-md btn-toggle btn-info AgentOnlyCallbacks active" data-toggle="button" aria-pressed="true" autocomplete="off">
...
<?php } ?>
            ...
            <div class="modal-footer modal-footer-uniform">
                ...
                <button type="button" class="btn btn-success float-right btn-app" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-dark float-right btn-app" style="margin-right:10px;" onclick="CallBackDatE_submit();return false;">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
echo $zi ?>;width:100%;height:100%;background-color:#e9e9e9;display:none" id="CallBackSelectBoxOLD">
...
if ($comments_callback_screen != 'REPLACE_CB_NOTES') {
    echo "<div class='col-lg-3 col-md-3 col-sm-4 col-xs-6'>
			<div class='form-group'>
				<div class='form-line'><label for=\"CallBackCommenTsField\">CB Comments</label><input class=\"form-control\" type=\"text\" name=\"CallBackCommenTsFieldOLD\" id=\"CallBackCommenTsField\" size=\"50\" maxlength=\"255\" /></div></div></div>\n";
} else {
...
if (($outbound_autodial_active > 0) and ( $disable_blended_checkbox < 1) and ( $dial_method != 'INBOUND_MAN') and ( $VU_agent_choose_blended > 0)) {
    ?>
                    <input type="checkbox" style="display:none" class="filled-in" name="CloserSelectBlended" id="CloserSelectBlended"  value="0" />
                    <label for="CloserSelectBlended"> <?php echo _QXZ("BLENDED CALLING(outbound activated)"); ?></label>
    <?php
}
?>
...
<!--<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
    echo $zi
?>;height:100%;width:100%;background-color:#e9e9e9;" id="CloserSelectBox1">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
echo $zi
?>;height:100%;width:100%;background-color:#e9e9e9;" id="TerritorySelectBox">
...
echo $zi
?>;height:25%;width:25%;background-color:#e9e9e9;" id="NothingBox">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
echo $zi
?>;width:100%;height:100%;background-color:#e9e9e9;" id="CalLLoGDisplaYBox">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
echo $zi
?>;height:100%;width:100%;background-color:#e9e9e9;" id="SearcHContactsDisplaYBox">
    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8" style="margin-left:16%; ">
        <div class="card" >
            <div class="header">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
echo $zi
?>;width:100%;height:100%;background-color:#e9e9e9;" id="SearcHResultSContactsBox">
    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8" style="margin-left:16%; ">
        <div class="card" >
            <div class="header">
...
<span style="position:absolute;z-index:<?php $zi++;
      echo $zi
?>;height:100%;width:100%;left:0px;top:0px;background-color:#e9e9e9;" id="SearcHForMDisplaYBox">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
echo $zi
?>;width:100%;height:100%;background-color:#e9e9e9;" id="SearcHResultSDisplaYBox">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
echo $zi
?>;width:100%;height:100%;background-color:#e9e9e9;" id="CalLNotesDisplaYBox">
    <div class="container" >
...
<span style="position:absolute;left:0px;top:0px;z-index:99999;width:100%;height:100%;background-color:#e9e9e9;visibility:hidden;" id="LeaDInfOBox">
    <div style="position:absolute;width:100%;height:100%;background-color:#e9e9e9;"></div>
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
      echo $zi ?>;width:100%;height:100%;background-color:#e9e9e9;" id="PauseCodeSelectBox">
    <div style="position:fixed;width:100%;height:100%;background-color:#e9e9e9;"></div>
    <div class="row clearfix">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="margin-left:25%">
            <div class="card">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
        echo $zi
?>;width:100%;height:100%;background-color:#e9e9e9;" id="PresetsSelectBox">
...
<span style="position:absolute;left:<?php echo $SCwidth ?>px;top:<?php echo $SLheight ?>px;z-index:<?php $zi++;
      echo $zi ?>; display:none;" id="AgentViewLinkSpan"><table cellpadding="0" cellspacing="0" border="0" width="91px"><tr><td align="right"><font class="body_small"><span id="AgentViewLink"><a href="#" onclick="AgentsViewOpen('AgentViewSpan', 'open');return false;"><?php echo _QXZ("Agents View +"); ?></a></span></font></td></tr></table></span>

<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
      echo $zi
?>;width:100%;height:100%;background-color:#e9e9e9;" id="GroupAliasSelectBox">
    <div class="container" style="margin: 10% 25%;">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
echo $zi
?>;width:100%;height:100%;background-color:#e9e9e9;" id="DiaLInGrouPSelectBox">
    <div class="container" style="margin: 10% 25%;">
        <div class="lead>">
...
<!-- <span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
echo $zi
?>;width:100%;height:100%;background-color:#e9e9e9; " id="blind_monitor_alert_span">
...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;
echo $zi
?>;width:100%;height:100%;background-color:#e9e9e9;" id="InvalidOpenerSpan">
    <div class="container text-center" style="margin:15% auto;">
        <div class="lead">
...
echo $zi
?>; display:none" id="GENDERhideFORieALT">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <button class="btn btn-danger btn-app" data-dismiss="modal">Cancel</button>
                        <a class="btn btn-success LogouTBoxLinkModal btn-app" id="LogouTBoxLinkModalNEW">Log me out</a>
                    </div>
                    <div class="col-md-3"></div>
                </div>
            </div>
...
<div id="NeWManuaLDiaLBoxModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header justify-content-center" style="background-color:#4eb598 !important;color:#fff !important;">
                <h4 class="modal-title" id="myModalLabel">Manual Dial</h4>
                <!--<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>-->
            </div>
            <div class="modal-body">
                <div class="input-group">
                    <span class="input-group-addon bg-secondary"><i class="fa fa-phone"></i></span>
                    <input type="text" size="14" maxlength="18" name="MDPhonENumbeR" id="MDPhonENumbeR" class="form-control" value="" placeholder="Phone Number"/>
                </div>
                <table class="table" style="display:none;">
                    <tr style="display:none;">
                        ...
                        <td align="right">
                            <div class="col-md-6">
                                <input type="text" size="7" maxlength="10" name="MDDiaLCodE" id="MDDiaLCodE" class="form-control" value="" />
...
?>
    ...
    <div class="modal-footer">
        ...
        <button type="button" data-dismiss="modal" class="btn btn-danger waves-effect btn-app float-left" >Close</button>
    </div>
</div>
<!-- /.modal-content -->
</div>
...
<?php } ?>
            ...
            <div class="modal-footer modal-footer-uniform">
                <!-- <button type="button" class="btn btn-close float-right btn-app" data-dismiss="modal">Close</button> -->
                <button type="button" class="btn btn-close float-right btn-app btn-success btn_submit">OK</button>
            </div>
        </div>
    </div>
</div>
...
<div id="InboundCallBoxModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" style="margin: 0 auto;top: 25%;width: 20%;">
        <div class="modal-content">
            <div class="modal-header justify-content-center" style="background-color:#4eb598 !important;color:#fff !important;">
                <h4 class="modal-title" id="myModalLabel">Inbound Call</h4>
                <!--<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>-->
            </div>
            <div class="modal-body">
                <div class="input-group">
                    <span class="input-group-addon bg-secondary"><i class="fa fa-phone"></i></span>
                    <input type="text" size="14" maxlength="18" id="inbound_call_phone" class="form-control" value="" placeholder="Phone Number"/>
                </div>
            </div>
            <div class="modal-footer">
                <!-- <button type="button" class="btn btn-danger waves-effect btn-app float-right" onclick=""><i class="fa fa-phone fa-rotate-hangup"></i></button> -->
                <button type="button" class="btn btn-success waves-effect btn-app float-right" onclick="AutoDial_ReSume_PauSe('VDADready','','','','','','','YES');"><i class="fa fa-phone" style="display: inline;margin-right: 10px;"></i>Click to Receive call</button>
                <button type="button" data-dismiss="modal" class="btn btn-info waves-effect btn-app float-left" >Close</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal center-modal fade" id="CallInformation-Modal" tabindex="-1" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header justify-content-center" style="background-color:#4eb598 !important;color:#fff !important;">
                <h5 class="modal-title">Call Information</h5>
                <button type="button" class="close" data-dismiss="modal">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<?php foreach ($Neutral as $dispoNeutral) { ?>
                            <button type="button" class="btn btn-secondary w100 mb-10 dispoBTN" ondblclick="DispoSubmit()" onclick="DispoSelectContent_create('<?php echo $dispoNeutral['status']; ?>', 'ADD', 'YES');return false;" data-toggle="tooltip" title="<?php echo $dispoNeutral['status_name']; ?>"><?php echo $dispoNeutral['status']." - ".$dispoNeutral['status_name']; ?></button>
<?php } ?>
                    </div>
                    <div class="col-3 red pt-10 pb-10"><p>Positive</p>
<?php foreach ($Positive as $dispoPositive) { ?>
                            <button type="button" class="btn btn-secondary w100 mb-10 dispoBTN" ondblclick="DispoSubmit()" onclick="DispoSelectContent_create('<?php echo $dispoPositive['status']; ?>', 'ADD', 'YES');return false;" data-toggle="tooltip" title="<?php echo $dispoPositive['status_name']; ?>"><?php echo $dispoPositive['status']." - ".$dispoPositive['status_name']; ?></button>
<?php } ?>
                    </div>
                    <div class="col-3 yellow pt-10 pb-10"><p>Negative</p>
<?php foreach ($Negative as $dispoNegative) { ?>
                            <button type="button" class="btn btn-secondary w100 mb-10 dispoBTN" ondblclick="DispoSubmit()" onclick="DispoSelectContent_create('<?php echo $dispoNegative['status']; ?>', 'ADD', 'YES');return false;" data-toggle="tooltip" title="<?php echo $dispoNegative['status_name']; ?>"><?php echo $dispoNegative['status']." - ".$dispoNegative['status_name']; ?></button>
<?php } ?>
                    </div>
                    <div class="col-3 orange pt-10 pb-10"><p>Unconcluded</p>
<?php foreach ($Unconcluded as $dispoUnconcluded) { ?>
                            <button type="button" class="btn btn-secondary w100 mb-10 dispoBTN" ondblclick="DispoSubmit()" onclick="DispoSelectContent_create('<?php echo $dispoUnconcluded['status']; ?>', 'ADD', 'YES');return false;" data-toggle="tooltip" title="<?php echo $dispoUnconcluded['status_name']; ?>"><?php echo $dispoUnconcluded['status']." - ".$dispoUnconcluded['status_name']; ?></button>
<?php } ?>
                    </div>
                </div>
            </div>
            <div class="modal-footer modal-footer-uniform">
                <div class="row">
                    <div class="col-5">
                        ...
                        <option value="">Pause-DEFAULT</option>
<?php
foreach ($VARpause_codes1 as $key => $val) {
    ...
    <?php }
                    ...
                    <div class="col-3">
                        ...
                        <br/><br/>
                        <input type="hidden" name="tag" value="" class="form-control" placeholder="Tag" id="TagList"/>
                    </div>
                    <div class="col-4">
                        <p align="right">
...
<style>
    .AgentCallStatus .active{padding: 15px}
</style>
<!--Call Disposition START-->
<div class="modal center-modal fade" id="CallTransfer-Modal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header justify-content-center" style="background-color:#4eb598 !important;color:#fff !important;">
                <h5 class="modal-title ">Agent Call Status</h5>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group row TypeSelection Agent-Selection" style="display:none;">
                            ...
                            <div class="col-md-9">
                                <div class="input-group"> <span class="input-group-addon"><i class="fa fa-user"></i> </span>
                                    <select class="form-control form-control-xs selectpicker" name="AgentXferViewSelect" onchange="AgentsXferSelect(this.value, 'AgentXferViewSelect');return false;" data-size="7" data-live-search="true" data-title="Select Agent" id="AgentXferViewSelect" data-width="90%"></select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <a href="javascript:void(0);" class="btn btn-success btn-app AgentCallStatusBTN" title="Dial With Customer" id="xfer_cust_dial_btn" onclick="SendManualDial('YES', 'YES');$('#transfer_cancel').prop('disabled', function (i, v) {
                                            return !v;
                                        });
                                        return false;"><i class="fa fa-users"></i></a>
                                <a href="javascript:void(0);" class="btn btn-success btn-app AgentCallStatusBTN" title="Dial Without Customer" onclick="xfer_park_dial('YES');
                                        $('#transfer_cancel').prop('disabled', function (i, v) {
                                            return !v;});return false;"><i class="fa fa-user"></i></a>
                                <a href="javascript:void(0);" class="btn btn-default btn-app text-success AgentCallStatusBTN PauseBTN"  title="Put Lead on Hold" onclick="xfer_park_dial('YES');return false;"><i class="fa fa-pause"></i></a>

                                <span class="GrabCall" style="display:none;">
                                </span>

                                <a href="javascript:void(0);" class="btn btn-success btn-app AgentCallStatusBTN" title="Dial And Hangup" id="DialBlind"><i class="fa fa-blind" onclick="mainxfer_send_redirect('XfeRBLIND', 'SIP/M3ST-00000c71', '', '', '', '0', 'YES');
                                        return false;"></i></a>
                                ...
                                <span id="Leave3WayCall"><a href="#" onclick="leave_3way_call('FIRST', 'YES');return false;" class="btn btn-danger btn-app" title="Leave 3 Way Call"><i class="fa fa-sign-out"></i></a></span>
                                <span id="HangupXferLine" style="display:none;"></span>
                                <span id="ParkXferLine" style="display:none;"></span>

                                <span>
                                    <a href="javascript:void(0);" onclick="xfercall_send_hangup();return false;" class="btn btn-warning btn-app" title="Hangup Transfer">
                                        <i class="fa fa-sign-out"></i>
                                    </a>
                                </span>
<!--                                <span>
                                    <a href="javascript:void(0);" onclick="bothcall_send_hangup('YES');return false;" class="btn btn-danger btn-app" title="Hangup Both Lines">
                                        <i class="fa fa-sign-out"></i>
                                    </a>
                                </span>-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="media-list media-list-hover media-list-divided" id="MessageSectionDiv-OLD">
...
<div class="modal center-modal fade" id="CustomerGonna-Modal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header justify-content-center" style="background-color:#4eb598 !important;color:#fff !important;">
                <h5 class="modal-title text-center">Agent Alert!!</h5>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <p><?php echo _QXZ("Customer has hung up:"); ?> <span id="CustomerGoneChanneL_NEW"></span></p>
                    </div>
                </div>
            </div>
            <div class="modal-footer modal-footer-uniform">
                <button type="button" class="btn btn-danger btn-app" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-success btn-app float-right" onclick="CustomerGoneHangup();
                        return false;"><?php echo _QXZ("Finish and Disposition Call"); ?></button>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-widget widget-user-4">
                            ...
                            <div class="widget-user-header bg-blue-active" style="background-color:#4eb598 !important;color:#fff !important;">
                                <div class="overlay dark">
                                    <h3 class="widget-user-username"><?php echo $UserDetail['full_name']; ?></h3>
                                    <h6 class="widget-user-desc" style="margin-bottom:5px;"><?php echo $UserDetail['user']; ?></h6>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 border-right">
                                        <div class="description-block">
                                            <h5 class="description-header"><?php echo $VD_campaign; ?></h5>
                                            <span class="description-text">Campaign</span>
                                        </div>
                                        <!-- /.description-block -->
                                    </div>
                                    <!-- /.col -->
                                    <div class="col-sm-4 border-right">
                                        <div class="description-block">
                                            <h5 class="description-header"><?php echo $SIP_user; ?></h5>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="description-block">
                                            <h5 class="description-header"><?php echo $UserDetail['user_group']; ?></h5>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background-color:#4eb598 !important;color:#fff !important;">
                    <h4 class="modal-title" id="myLargeModalLabel">Leaderboard</h4>
                    <!--<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>-->
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive" id="LeaderBoardPerformance-Section">
...
<div class="modal fade" id="LeaInformation">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-black" style="background-color:#4eb598 !important;color:#fff !important;">
            <!--<div class="modal-header bg-black">-->
                    <h4 class="modal-title" id="">Lead Info</h4>
                    <!--<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>-->
            </div>
            <div class="modal-body">
