<script language="Javascript">
	...
	var MTvar;
	var NOW_TIME = '<?php echo (isset($NOW_TIME) ? $NOW_TIME : ''); ?>';
	var SQLdate = '<?php echo (isset($NOW_TIME) ? $NOW_TIME : ''); ?>';
	var StarTtimE = '<?php echo (isset($StarTtimE) ? $StarTtimE : ''); ?>';
	var UnixTime = '<?php echo (isset($StarTtimE) ? $StarTtimE : ''); ?>';
	var UnixTimeMS = 0;
	var JSseedTIME = <?php echo (isset($JS_date) ? $JS_date : '');  ?>;
	var t = new Date();
	...
	LCAt = new Array('','','','','','');
	LMAe = new Array('','','','','','');
	var CalL_XC_a_Dtmf = '<?php echo (isset($xferconf_a_dtmf) ? $xferconf_a_dtmf : ''); ?>';
	var CalL_XC_a_NuMber = '<?php echo (isset($xferconf_a_number) ? $xferconf_a_number : ''); ?>';
	var CalL_XC_b_Dtmf = '<?php echo (isset($xferconf_b_dtmf) ? $xferconf_b_dtmf : ''); ?>';
	var CalL_XC_b_NuMber = '<?php echo (isset($xferconf_b_number) ? $xferconf_b_number : ''); ?>';
	var CalL_XC_c_NuMber = '<?php echo (isset($xferconf_c_number) ? $xferconf_c_number : ''); ?>';
	var CalL_XC_d_NuMber = '<?php echo (isset($xferconf_d_number) ? $xferconf_d_number : ''); ?>';
	var CalL_XC_e_NuMber = '<?php echo (isset($xferconf_e_number) ? $xferconf_e_number : ''); ?>';
	var VU_hotkeys_active = '<?php echo (isset($VU_hotkeys_active) ? $VU_hotkeys_active : ''); ?>';
	var VU_agent_choose_ingroups = '<?php echo (isset($VU_agent_choose_ingroups) ? $VU_agent_choose_ingroups : ''); ?>';
	var VU_agent_choose_ingroups_DV = '';
	var agent_choose_territories = '<?php echo (isset($VU_agent_choose_territories) ? $VU_agent_choose_territories : ''); ?>';
	var agent_select_territories = '<?php echo (isset($agent_select_territories) ? $agent_select_territories : ''); ?>';
	var agent_choose_blended = '<?php echo (isset($VU_agent_choose_blended) ? $VU_agent_choose_blended : ''); ?>';
	var VU_closer_campaigns = '<?php echo (isset($VU_closer_campaigns) ? $VU_closer_campaigns : ''); ?>';
	...
	var CallBackPhone = '';
	var DispoQMcsCODE = '';
	var scheduled_callbacks = '<?php echo (isset($scheduled_callbacks) ? $scheduled_callbacks : ''); ?>';
	var dispo_check_all_pause = '<?php echo (isset($dispo_check_all_pause) ? $dispo_check_all_pause : ''); ?>';
	var api_check_all_pause = '<?php echo (isset($api_check_all_pause) ? $api_check_all_pause : ''); ?>';
	VARgroup_alias_ids = new Array(<?php echo (isset($VARgroup_alias_ids) ? $VARgroup_alias_ids : ''); ?>);
	VARgroup_alias_names = new Array(<?php echo (isset($VARgroup_alias_names) ? $VARgroup_alias_names : ''); ?>);
	VARcaller_id_numbers = new Array(<?php echo (isset($VARcaller_id_numbers) ? $VARcaller_id_numbers : ''); ?>);
	var VD_group_aliases_ct = '<?php echo (isset($VD_group_aliases_ct) ? $VD_group_aliases_ct : ''); ?>';
	var agent_allow_group_alias = '<?php echo (isset($agent_allow_group_alias) ? $agent_allow_group_alias : ''); ?>';
	var default_group_alias = '<?php echo (isset($default_group_alias) ? $default_group_alias : ''); ?>';
	var default_group_alias_cid = '<?php echo (isset($default_group_alias_cid) ? $default_group_alias_cid : ''); ?>';
	var active_group_alias = '';
	var agent_pause_codes_active = '<?php echo (isset($agent_pause_codes_active) ? $agent_pause_codes_active : ''); ?>';
	VARpause_codes = new Array(<?php echo (isset($VARpause_codes) ? $VARpause_codes : ''); ?>);
	VARpause_code_names = new Array(<?php echo (isset($VARpause_code_names) ? $VARpause_code_names : ''); ?>);
	VARpause_code_mgrapr = new Array(<?php echo (isset($VARpause_code_mgrapr) ? $VARpause_code_mgrapr : ''); ?>);
	var VD_pause_codes_ct = '<?php echo (isset($VD_pause_codes_ct) ? $VD_pause_codes_ct : ''); ?>';
	VARpreset_names = new Array(<?php echo (isset($VARpreset_names) ? $VARpreset_names : ''); ?>);
	VARpreset_numbers = new Array(<?php echo (isset($VARpreset_numbers) ? $VARpreset_numbers : ''); ?>);
	VARpreset_dtmfs = new Array(<?php echo (isset($VARpreset_dtmfs) ? $VARpreset_dtmfs : ''); ?>);
	VARpreset_hide_numbers = new Array(<?php echo (isset($VARpreset_hide_numbers) ? $VARpreset_hide_numbers : ''); ?>);
	var VD_preset_names_ct = '<?php echo (isset($VD_preset_names_ct) ? $VD_preset_names_ct : ''); ?>';
	...
	sVARstatuses = new Array(<?php echo (isset($VARstatuses) ? $VARstatuses : ''); ?>);
	sVARstatusnames = new Array(<?php echo (isset($VARstatusnames) ? $VARstatusnames : ''); ?>);
	sVARSELstatuses = new Array(<?php echo (isset($VARSELstatuses) ? $VARSELstatuses : ''); ?>);
	sVARCBstatuses = new Array(<?php echo (isset($VARCBstatuses) ? $VARCBstatuses : ''); ?>);
	sVARMINstatuses = new Array(<?php echo (isset($VARMINstatuses) ? $VARMINstatuses : ''); ?>);
	sVARMAXstatuses = new Array(<?php echo (isset($VARMAXstatuses) ? $VARMAXstatuses : ''); ?>);
	var sVARCBstatusesLIST = '<?php echo (isset($VARCBstatusesLIST) ? $VARCBstatusesLIST : ''); ?>';
	var sVD_statuses_ct = '<?php echo (isset($VD_statuses_ct) ? $VD_statuses_ct : ''); ?>';
	var sVARSELstatuses_ct = '<?php echo (isset($VARSELstatuses_ct) ? $VARSELstatuses_ct : ''); ?>';
	cVARstatuses = new Array(<?php echo (isset($cVARstatuses) ? $cVARstatuses : ''); ?>);
	cVARstatusnames = new Array(<?php echo (isset($cVARstatusnames) ? $cVARstatusnames : '');  ?>);
	cVARSELstatuses = new Array(<?php echo (isset($cVARSELstatuses) ? $cVARSELstatuses : ''); ?>);
	cVARCBstatuses = new Array(<?php echo (isset($cVARCBstatuses) ? $cVARCBstatuses : ''); ?>);
	cVARMINstatuses = new Array(<?php echo (isset($cVARMINstatuses) ? $cVARMINstatuses : ''); ?>);
	cVARMAXstatuses = new Array(<?php echo (isset($cVARMAXstatuses) ? $cVARMAXstatuses : ''); ?>);
	var cVARCBstatusesLIST = '<?php echo (isset($cVARCBstatusesLIST) ? $cVARCBstatusesLIST : ''); ?>';
	var cVD_statuses_ct = '<?php echo (isset($VD_statuses_camp) ? $VD_statuses_camp : ''); ?>';
	var cVARSELstatuses_ct = '<?php echo (isset($cVARSELstatuses_ct) ? $cVARSELstatuses_ct : ''); ?>';
	VARingroups = new Array(<?php echo (isset($VARingroups) ? $VARingroups : ''); ?>);
	var INgroupCOUNT = '<?php echo (isset($INgrpCT) ? $INgrpCT : ''); ?>';

	VARemailgroups = new Array(<?php echo (isset($VARemailgroups) ? $VARemailgroups : ''); ?>);
	// var EMAILgroupCOUNT = '<?php echo (isset($EMAILgrpCT) ? $EMAILgrpCT : ''); ?>';
	var EMAILgroupCOUNT = 0;
	var incomingEMAILgroups= new Array();

	VARchatgroups = new Array(<?php echo (isset($VARchatgroups) ? $VARchatgroups : ''); ?>);
	var CHATgroupCOUNT = 0;
	var incomingCHATgroups= new Array();

	VARphonegroups = new Array(<?php echo (isset($VARphonegroups) ? $VARphonegroups : ''); ?>);
	// var PHONEgroupCOUNT = '<?php echo (isset($PHONEgrpCT) ? $PHONEgrpCT : '');  ?>';
	var PHONEgroupCOUNT = 0;

	var VARingroup_handlers = new Array(<?php echo (isset($VARingroup_handlers) ? $VARingroup_handlers : ''); ?>);
	var QUEUEpadding=0;

	VARdialingroups = new Array(<?php echo (isset($VARdialingroups) ? $VARdialingroups : ''); ?>);
	var dialINgroupCOUNT = '<?php echo (isset($dialINgrpCT) ? $dialINgrpCT : ''); ?>';
	VARterritories = new Array(<?php echo (isset($VARterritories) ? $VARterritories : ''); ?>);
	var territoryCOUNT = '<?php echo (isset($territoryCT) ? $territoryCT : ''); ?>';
	VARxfergroups = new Array(<?php echo (isset($VARxfergroups) ? $VARxfergroups : ''); ?>);
	VARxfergroupsnames = new Array(<?php echo (isset($VARxfergroupsnames) ? $VARxfergroupsnames : ''); ?>);
	var XFgroupCOUNT = '<?php echo (isset($XFgrpCT) ? $XFgrpCT : ''); ?>';
	var default_xfer_group = '<?php echo (isset($default_xfer_group) ? $default_xfer_group : ''); ?>';
	var default_xfer_group_name = '<?php echo (isset($default_xfer_group_name) ? $default_xfer_group_name : ''); ?>';
	var LIVE_default_xfer_group = '<?php echo (isset($default_xfer_group) ? $default_xfer_group : ''); ?>';
	var HK_statuses_camp = '<?php echo (isset($HK_statuses_camp) ? $HK_statuses_camp : ''); ?>';
	HKhotkeys = new Array(<?php echo (isset($HKhotkeys) ? $HKhotkeys : ''); ?>);
	HKstatuses = new Array(<?php echo (isset($HKstatuses) ? $HKstatuses : ''); ?>);
	HKstatusnames = new Array(<?php echo (isset($HKstatusnames) ? $HKstatusnames : ''); ?>);
	...
	?>
	var view_scripts = '<?php echo (isset($view_scripts) ? $view_scripts : ''); ?>';
	var LOGfullname = '<?php echo (isset($LOGfullname) ? $LOGfullname : ''); ?>';
	var LOGemail = '<?php echo (isset($LOGemail) ? $LOGemail : ''); ?>';
	var recLIST = '';
	var filename = '';
	var last_filename = '';
	var LCAcount = 0;
	var LMAcount = 0;
	var filedate = '<?php echo (isset($FILE_TIME) ? $FILE_TIME : ''); ?>';
	var agcDIR = '<?php echo (isset($agcDIR) ? $agcDIR : ''); ?>';
	var agcPAGE = '<?php echo (isset($agcPAGE) ? $agcPAGE : ''); ?>';
	var extension = '<?php echo (isset($extension) ? $extension : ''); ?>';
	var extension_xfer = '<?php echo (isset($extension) ? $extension : ''); ?>';
	var dialplan_number = '<?php echo (isset($dialplan_number) ? $dialplan_number : ''); ?>';
	var ext_context = '<?php echo (isset($ext_context) ? $ext_context : ''); ?>';
	var login_context = '<?php echo (isset($login_context) ? $login_context : ''); ?>';
	var protocol = '<?php echo (isset($protocol) ? $protocol : ''); ?>';
	var agentchannel = '';
	var local_gmt ='<?php echo (isset($local_gmt) ? $local_gmt : ''); ?>';
	var server_ip = '<?php echo (isset($server_ip) ? $server_ip : ''); ?>';
	var server_ip_dialstring = '<?php echo (isset($server_ip_dialstring) ? $server_ip_dialstring : ''); ?>';
	var asterisk_version = '<?php echo (isset($asterisk_version) ? $asterisk_version : ''); ?>';
<?php
if ($enable_fast_refresh < 1) {echo "\tvar refresh_interval = 1000;\n";}
	else {echo "\tvar refresh_interval = $fast_refresh_rate;\n";}
?>
	var session_id = '<?php echo (isset($session_id) ? $session_id : ''); ?>';
	...
	var VICIDiaL_allow_closers = '<?php echo (isset($VICIDiaL_allow_closers) ? $VICIDiaL_allow_closers : ''); ?>';
	var VICIDiaL_closer_blended = '0';
	var VU_closer_default_blended = '<?php echo (isset($VU_closer_default_blended) ? $VU_closer_default_blended : ''); ?>';
	var VDstop_rec_after_each_call = '<?php echo (isset($VDstop_rec_after_each_call) ? $VDstop_rec_after_each_call : ''); ?>';
	var phone_login = '<?php echo (isset($phone_login) ? $phone_login : ''); ?>';
	var original_phone_login = '<?php echo (isset($original_phone_login) ? $original_phone_login : ''); ?>';
	var phone_pass = '<?php echo (isset($phone_pass) ? $phone_pass : ''); ?>';
	var user = '<?php echo (isset($VD_login) ? $VD_login : ''); ?>';
	var user_abb = '<?php echo (isset($user_abb) ? $user_abb : ''); ?>';
	var pass = '<?php if (strlen($pass_hash)>12) {echo $pass_hash;} else {echo $VD_pass;} ?>';
	var orig_pass = '<?php echo (isset($VD_pass) ? $VD_pass : ''); ?>';
	var pass_hash = '<?php echo (isset($pass_hash) ? $pass_hash : ''); ?>';
	var campaign = '<?php echo (isset($VD_campaign) ? $VD_campaign : ''); ?>';
	var group = '<?php echo (isset($VD_campaign) ? $VD_campaign : ''); ?>';
	var VICIDiaL_web_form_address_enc = '<?php echo (isset($VICIDiaL_web_form_address_enc) ? $VICIDiaL_web_form_address_enc : ''); ?>';
	var VICIDiaL_web_form_address = '<?php echo (isset($VICIDiaL_web_form_address) ? $VICIDiaL_web_form_address : ''); ?>';
	var VDIC_web_form_address = '<?php echo (isset($VICIDiaL_web_form_address) ? $VICIDiaL_web_form_address : ''); ?>';
	var VICIDiaL_web_form_address_two_enc = '<?php echo (isset($VICIDiaL_web_form_address_two_enc) ? $VICIDiaL_web_form_address_two_enc : ''); ?>';
	var VICIDiaL_web_form_address_two = '<?php echo (isset($VICIDiaL_web_form_address_two) ? $VICIDiaL_web_form_address_two : ''); ?>';
	var VDIC_web_form_address_two = '<?php echo (isset($VICIDiaL_web_form_address_two) ? $VICIDiaL_web_form_address_two : ''); ?>';
	var VICIDiaL_web_form_address_three_enc = '<?php echo (isset($VICIDiaL_web_form_address_three_enc) ? $VICIDiaL_web_form_address_three_enc : ''); ?>';
	var VICIDiaL_web_form_address_three = '<?php echo (isset($VICIDiaL_web_form_address_three) ? $VICIDiaL_web_form_address_three : '');  ?>';
	var VDIC_web_form_address_three = '<?php echo (isset($VICIDiaL_web_form_address_three) ? $VICIDiaL_web_form_address_three : ''); ?>';
	var CalL_ScripT_id = '';
	var CalL_ScripT_color = '';
	var CalL_AutO_LauncH = '';
//	var panel_bgcolor = '<?php echo (isset($MAIN_COLOR) ? $MAIN_COLOR : ''); ?>';
	var panel_bgcolor = '#fce3ec';
	var CusTCB_bgcolor = '#FFFF66';
	var auto_dial_level = '<?php echo (isset($auto_dial_level) ? $auto_dial_level : ''); ?>';
	var starting_dial_level = '<?php echo (isset($auto_dial_level) ? $auto_dial_level : ''); ?>';
	var dial_timeout = '<?php echo (isset($dial_timeout) ? $dial_timeout : ''); ?>';
	var manual_dial_timeout = '<?php echo (isset($manual_dial_timeout) ? $manual_dial_timeout : ''); ?>';
	var dial_prefix = '<?php echo (isset($dial_prefix) ? $dial_prefix : ''); ?>';
	var manual_dial_prefix = '<?php echo (isset($manual_dial_prefix) ? $manual_dial_prefix : ''); ?>';
	var three_way_dial_prefix = '<?php echo (isset($three_way_dial_prefix) ? $three_way_dial_prefix : ''); ?>';
	var campaign_cid = '<?php echo (isset($campaign_cid) ? $campaign_cid : ''); ?>';
	var use_custom_cid = '<?php echo (isset($use_custom_cid) ? $use_custom_cid : ''); ?>';
	var campaign_vdad_exten = '<?php echo (isset($campaign_vdad_exten) ? $campaign_vdad_exten : ''); ?>';
	var campaign_leads_to_call = '<?php echo (isset($campaign_leads_to_call) ? $campaign_leads_to_call : ''); ?>';
	var epoch_sec = <?php echo (isset($StarTtimE) ? $StarTtimE : ''); ?>;
	var dtmf_send_extension = '<?php echo (isset($dtmf_send_extension) ? $dtmf_send_extension : ''); ?>';
	var recording_exten = '<?php echo (isset($campaign_rec_exten) ? $campaign_rec_exten : ''); ?>';
	var campaign_recording = '<?php echo (isset($campaign_recording) ? $campaign_recording : ''); ?>';
	var campaign_rec_filename = '<?php echo (isset($campaign_rec_filename) ? $campaign_rec_filename : ''); ?>';
	var LIVE_campaign_recording = '<?php echo (isset($campaign_recording) ? $campaign_recording : ''); ?>';
	var LIVE_campaign_rec_filename = '<?php echo (isset($campaign_rec_filename) ? $campaign_rec_filename : ''); ?>';
	var LIVE_default_group_alias = '<?php echo (isset($default_group_alias) ? $default_group_alias : ''); ?>';
	var LIVE_caller_id_number = '<?php echo (isset($default_group_alias_cid) ? $default_group_alias_cid : ''); ?>';
	var LIVE_web_vars = '<?php echo (isset($default_web_vars) ? $default_web_vars : ''); ?>';
	var default_web_vars = '<?php echo (isset($default_web_vars) ? $default_web_vars : ''); ?>';
	var campaign_script = '<?php echo (isset($campaign_script) ? $campaign_script : ''); ?>';
	var get_call_launch = '<?php echo (isset($get_call_launch) ? $get_call_launch : ''); ?>';
	var campaign_am_message_exten = '<?php echo (isset($campaign_am_message_exten) ? $campaign_am_message_exten : ''); ?>';
	var park_on_extension = '<?php echo (isset($VICIDiaL_park_on_extension) ? $VICIDiaL_park_on_extension : ''); ?>';
	var park_count=0;
	...
	var dtmf_silent_prefix = '<?php echo (isset($dtmf_silent_prefix) ? $dtmf_silent_prefix : ''); ?>';
	var conf_silent_prefix = '<?php echo (isset($conf_silent_prefix) ? $conf_silent_prefix : ''); ?>';
	var menuheight = 30;
	var menuwidth = 30;
	var HTheight = '<?php echo (isset($HTheight) ? $HTheight : ''); ?>px';
	var WRheight = '<?php echo (isset($WRheight) ? $WRheight : ''); ?>px';
	var CAwidth = '<?php echo (isset($CAwidth) ? $CAwidth : ''); ?>px';
	var menufontsize = 8;
	...
	var XfeR_channel = '';
	var XDcheck = '';
	var agent_log_id = '<?php echo (isset($agent_log_id) ? $agent_log_id : ''); ?>';
	var session_name = '<?php echo (isset($session_name) ? $session_name : ''); ?>';
	var AutoDialReady = 0;
	...
	var callholdstatus = '<?php echo (isset($callholdstatus) ? $callholdstatus : ''); ?>'
	var agentcallsstatus = '<?php echo (isset($agentcallsstatus) ? $agentcallsstatus : ''); ?>'
	var campagentstatctmax = '<?php echo (isset($campagentstatctmax) ? $campagentstatctmax : ''); ?>'
	...
	var mdnLisT_id = '<?php echo (isset($manual_dial_list_id) ? $manual_dial_list_id : ''); ?>';
	var VU_vicidial_transfers = '<?php echo (isset($VU_vicidial_transfers) ? $VU_vicidial_transfers : ''); ?>';
	var agentonly_callbacks = '<?php echo (isset($agentonly_callbacks) ? $agentonly_callbacks : ''); ?>';
	var agentcall_manual = '<?php echo (isset($agentcall_manual) ? $agentcall_manual : ''); ?>';
	var manual_dial_preview = '<?php echo (isset($manual_dial_preview) ? $manual_dial_preview : ''); ?>';
	var manual_preview_dial = '<?php echo (isset($manual_preview_dial) ? $manual_preview_dial : ''); ?>';
	var starting_alt_phone_dialing = '<?php echo (isset($alt_phone_dialing) ? $alt_phone_dialing : ''); ?>';
	var alt_phone_dialing = '<?php echo (isset($alt_phone_dialing) ? $alt_phone_dialing : ''); ?>';
	var alt_number_dialing = '<?php echo (isset($alt_number_dialing) ? $alt_number_dialing : ''); ?>';
	var timer_alt_seconds = '<?php echo (isset($timer_alt_seconds) ? $timer_alt_seconds : ''); ?>';
	var timer_alt_count=0;
	var timer_alt_trigger=0;
	var manual_auto_next = '<?php echo (isset($manual_auto_next) ? $manual_auto_next : ''); ?>';
	var manual_auto_next_count = '<?php echo (isset($manual_auto_next) ? $manual_auto_next : ''); ?>';
	var manual_auto_next_trigger=0;
	var manual_auto_show = '<?php echo (isset($manual_auto_show) ? $manual_auto_show : ''); ?>';
	var last_mdtype='';
	var DefaulTAlTDiaL = '<?php echo (isset($DefaulTAlTDiaL) ? $DefaulTAlTDiaL : ''); ?>';
	var wrapup_seconds = '<?php echo (isset($wrapup_seconds) ? $wrapup_seconds : ''); ?>';
	var wrapup_message = '<?php echo (isset($wrapup_message) ? $wrapup_message : ''); ?>';
	var wrapup_counter = 0;
	var wrapup_waiting = 0;
	var wrapup_bypass = '<?php echo (isset($wrapup_bypass) ? $wrapup_bypass : ''); ?>';
	var wrapup_after_hotkey = '<?php echo (isset($wrapup_after_hotkey) ? $wrapup_after_hotkey : ''); ?>';
	var use_internal_dnc = '<?php echo (isset($use_internal_dnc) ? $use_internal_dnc : ''); ?>';
	var use_campaign_dnc = '<?php echo (isset($use_campaign_dnc) ? $use_campaign_dnc : ''); ?>';
	var three_way_call_cid = '<?php echo (isset($three_way_call_cid) ? $three_way_call_cid : ''); ?>';
	var outbound_cid = '<?php echo (isset($outbound_cid) ? $outbound_cid : ''); ?>';
	var threeway_cid = '';
	var cid_choice = '';
	var prefix_choice = '';
	var agent_dialed_number='';
	var agent_dialed_type='';
	var allcalls_delay = '<?php echo (isset($allcalls_delay) ? $allcalls_delay : ''); ?>';
	var omit_phone_code = '<?php echo (isset($omit_phone_code) ? $omit_phone_code : ''); ?>';
	var no_delete_sessions = '<?php echo (isset($no_delete_sessions) ? $no_delete_sessions : ''); ?>';
	var webform_session = '<?php echo (isset($webform_sessionname) ? $webform_sessionname : ''); ?>';
	var local_consult_xfers = '<?php echo (isset($local_consult_xfers) ? $local_consult_xfers : ''); ?>';
	var vicidial_agent_disable = '<?php echo (isset($vicidial_agent_disable) ? $vicidial_agent_disable : ''); ?>';
	var CBentry_time = '';
	var CBcallback_time = '';
	var CBuser = '';
	var CBcomments = '';
	var volumecontrol_active = '<?php echo (isset($volumecontrol_active) ? $volumecontrol_active : ''); ?>';
	var PauseCode_HTML = '';
	...
	var RedirecTxFEr = 0;
	var phone_ip = '<?php echo (isset($phone_ip) ? $phone_ip : ''); ?>';
	var enable_sipsak_messages = '<?php echo (isset($enable_sipsak_messages) ? $enable_sipsak_messages : ''); ?>';
	var allow_sipsak_messages = '<?php echo (isset($allow_sipsak_messages) ? $allow_sipsak_messages : ''); ?>';
	var HidEMonitoRSessionS = '<?php echo (isset($HidEMonitoRSessionS) ? $HidEMonitoRSessionS : ''); ?>';
	var LogouTKicKAlL = '<?php echo (isset($LogouTKicKAlL) ? $LogouTKicKAlL : ''); ?>';
	var flag_channels = '<?php echo (isset($flag_channels) ? $flag_channels : ''); ?>';
	var flag_string = '<?php echo (isset($flag_string) ? $flag_string : ''); ?>';
	var vdc_header_date_format = '<?php echo (isset($vdc_header_date_format) ? $vdc_header_date_format : ''); ?>';
	var vdc_customer_date_format = '<?php echo (isset($vdc_customer_date_format) ? $vdc_customer_date_format : ''); ?>';
	var vdc_header_phone_format = '<?php echo (isset($vdc_header_phone_format) ? $vdc_header_phone_format : ''); ?>';
	var disable_alter_custphone = '<?php echo (isset($disable_alter_custphone) ? $disable_alter_custphone : ''); ?>';
	var manual_dial_filter = '<?php echo (isset($manual_dial_filter) ? $manual_dial_filter : ''); ?>';
	var manual_dial_search_filter = '<?php echo (isset($manual_dial_search_filter) ? $manual_dial_search_filter : ''); ?>';
	var CopY_tO_ClipboarD = '<?php echo (isset($CopY_tO_ClipboarD) ? $CopY_tO_ClipboarD : ''); ?>';
	var inOUT = 'OUT';
	var useIE = '<?php echo (isset($useIE) ? $useIE : ''); ?>';
	var random = '<?php echo (isset($random) ? $random : ''); ?>';
	var threeway_end = 0;
	var agentphonelive = 0;
	var conf_dialed = 0;
	var leaving_threeway = 0;
	var blind_transfer = 0;
	var hangup_all_non_reserved = '<?php echo (isset($hangup_all_non_reserved) ? $hangup_all_non_reserved : ''); ?>';
	var dial_method = '<?php echo (isset($dial_method) ? $dial_method : ''); ?>';
	var web_form_target = '<?php echo (isset($web_form_target) ? $web_form_target : ''); ?>';
	...
	var VtigeRLogiNScripT = '<?php echo (isset($vtiger_screen_login) ? $vtiger_screen_login : ''); ?>';
	var VtigeRurl = '<?php echo (isset($vtiger_url) ? $vtiger_url : ''); ?>';
	var VtigeREnableD = '<?php echo (isset($enable_vtiger_integration) ? $enable_vtiger_integration : ''); ?>';
	var alert_enabled = '<?php echo (isset($VU_alert_enabled) ? $VU_alert_enabled : ''); ?>';
	var allow_alerts = '<?php echo (isset($VU_allow_alerts) ? $VU_allow_alerts : ''); ?>';
	var shift_logout_flag = 0;
	var api_logout_flag = 0;
	var vtiger_callback_id = 0;
	var agent_status_view = '<?php echo (isset($agent_status_view) ? $agent_status_view : ''); ?>';
	var agent_status_view_time = '<?php echo (isset($agent_status_view_time) ? $agent_status_view_time : ''); ?>';
	var agent_status_view_active = 0;
	var xfer_select_agents_active = 0;
	var even=0;
	var VU_user_group = '<?php echo (isset($VU_user_group) ? $VU_user_group : ''); ?>';
	var quick_transfer_button = '<?php echo (isset($quick_transfer_button) ? $quick_transfer_button : ''); ?>';
	var quick_transfer_button_enabled = '<?php echo (isset($quick_transfer_button_enabled) ? $quick_transfer_button_enabled : ''); ?>';
	var quick_transfer_button_orig = '';
	var quick_transfer_button_locked = '<?php echo (isset($quick_transfer_button_locked) ? $quick_transfer_button_locked : ''); ?>';
	var prepopulate_transfer_preset = '<?php echo (isset($prepopulate_transfer_preset) ? $prepopulate_transfer_preset : ''); ?>';
	var prepopulate_transfer_preset_enabled = '<?php echo (isset($prepopulate_transfer_preset_enabled) ? $prepopulate_transfer_preset_enabled : ''); ?>';
	var view_calls_in_queue = '<?php echo (isset($view_calls_in_queue) ? $view_calls_in_queue : ''); ?>';
	var view_calls_in_queue_launch = '<?php echo (isset($view_calls_in_queue_launch) ? $view_calls_in_queue_launch : ''); ?>';
	var view_calls_in_queue_active = '<?php echo (isset($view_calls_in_queue_launch) ? $view_calls_in_queue_launch : ''); ?>';
	var call_requeue_button = '<?php echo (isset($call_requeue_button) ? $call_requeue_button : ''); ?>';
	var no_hopper_dialing = '<?php echo (isset($no_hopper_dialing) ? $no_hopper_dialing : ''); ?>';
	var agent_dial_owner_only = '<?php echo (isset($agent_dial_owner_only) ? $agent_dial_owner_only : ''); ?>';
	var agent_display_dialable_leads = '<?php echo (isset($agent_display_dialable_leads) ? $agent_display_dialable_leads : ''); ?>';
	var no_empty_session_warnings = '<?php echo (isset($no_empty_session_warnings) ? $no_empty_session_warnings : ''); ?>';
	var script_width = '<?php echo (isset($SDwidth) ? $SDwidth : ''); ?>';
	var script_height = '<?php echo (isset($SSheight) ? $SSheight : ''); ?>';
//	var enable_second_webform = '<?php echo (isset($enable_second_webform) ? $enable_second_webform : ''); ?>';
	var enable_second_webform = 0;
//	var enable_third_webform = '<?php echo (isset($enable_third_webform) ? $enable_third_webform : ''); ?>';
	...
	var VU_custom_one = '<?php echo (isset($VU_custom_one) ? $VU_custom_one : ''); ?>';
	var VU_custom_two = '<?php echo (isset($VU_custom_two) ? $VU_custom_two : ''); ?>';
	var VU_custom_three = '<?php echo (isset($VU_custom_three) ? $VU_custom_three : ''); ?>';
	var VU_custom_four = '<?php echo (isset($VU_custom_four) ? $VU_custom_four : ''); ?>';
	var VU_custom_five = '<?php echo (isset($VU_custom_five) ? $VU_custom_five : ''); ?>';
	var crm_popup_login = '<?php echo (isset($crm_popup_login) ? $crm_popup_login : ''); ?>';
	var crm_login_address = '<?php echo (isset($crm_login_address) ? $crm_login_address : ''); ?>';
	var update_fields=0;
	var update_fields_data='';
	var campaign_timer_action = '<?php echo (isset($timer_action) ? $timer_action : ''); ?>';
	var campaign_timer_action_message = '<?php echo (isset($timer_action_message) ? $timer_action_message : ''); ?>';
	var campaign_timer_action_seconds = '<?php echo (isset($timer_action_seconds) ? $timer_action_seconds : ''); ?>';
	var campaign_timer_action_destination = '<?php echo (isset($timer_action_destination) ? $timer_action_destination : ''); ?>';
	var timer_action='';
	var timer_action_message='';
	var timer_action_seconds='';
	var timer_action_destination = '';
	var is_webphone='<?php echo (isset($is_webphone) ? $is_webphone : ''); ?>';
	var WebPhonEurl='<?php echo (isset($WebPhonEurl) ? $WebPhonEurl : ''); ?>';
	var pause_code_counter=1;
	var agent_call_log_view='<?php echo (isset($agent_call_log_view) ? $agent_call_log_view : ''); ?>';
	var scheduled_callbacks_alert='<?php echo (isset($scheduled_callbacks_alert) ? $scheduled_callbacks_alert : ''); ?>';
	var scheduled_callbacks_count='<?php echo (isset($scheduled_callbacks_count) ? $scheduled_callbacks_count : ''); ?>';
	var callback_days_limit='<?php echo (isset($callback_days_limit) ? $callback_days_limit : ''); ?>';
	var callback_active_limit='<?php echo (isset($callback_active_limit) ? $callback_active_limit : ''); ?>';
	var tmp_vicidial_id='';
	var agent_xfer_consultative='<?php echo (isset($agent_xfer_consultative) ? $agent_xfer_consultative : ''); ?>';
	var agent_xfer_dial_override='<?php echo (isset($agent_xfer_dial_override) ? $agent_xfer_dial_override : ''); ?>';
	var agent_xfer_vm_transfer='<?php echo (isset($agent_xfer_vm_transfer) ? $agent_xfer_vm_transfer : ''); ?>';
	var agent_xfer_blind_transfer='<?php echo (isset($agent_xfer_blind_transfer) ? $agent_xfer_blind_transfer : ''); ?>';
	var agent_xfer_dial_with_customer='<?php echo (isset($agent_xfer_dial_with_customer) ? $agent_xfer_dial_with_customer : ''); ?>';
	var agent_xfer_park_customer_dial='<?php echo (isset($agent_xfer_park_customer_dial) ? $agent_xfer_park_customer_dial : ''); ?>';
	var agent_xfer_park_3way='<?php echo (isset($agent_xfer_park_3way) ? $agent_xfer_park_3way : ''); ?>';
	var EAphone_code='';
	var EAphone_number='';
	var EAalt_phone_notes='';
	var EAalt_phone_active='';
	var EAalt_phone_count='';
	var conf_check_attempts = '<?php echo (isset($conf_check_attempts) ? $conf_check_attempts : ''); ?>';
	var conf_check_attempts_cleanup = '<?php echo ($conf_check_attempts + 2) ?>';
	var blind_monitor_warning='<?php echo (isset($blind_monitor_warning) ? $blind_monitor_warning : ''); ?>';
	var blind_monitor_message="<?php echo (isset($blind_monitor_message) ? $blind_monitor_message : ''); ?>";
	var blind_monitor_filename='<?php echo (isset($blind_monitor_filename) ? $blind_monitor_filename : ''); ?>';
	...
	var DiaLControl_auto_HTML = "<a href=\"javascript:void(0);\" class=\"btn btn-success\" onclick=\"AutoDial_ReSume_PauSe('VDADready','','','','','','','YES');\" title=\"Go Ready\"> <i class=\"fa fa-play\"></i> </a>";
	...
	var DiaLControl_auto_HTML_ready = "<a href=\"javascript:void(0);\" class=\"btn btn-danger\" onclick=\"AutoDial_ReSume_PauSe('VDADpause','','','','','','','YES');\" title=\"Go Pause\"> <i class=\"fa fa-stop\"></i> </a>";
...
//                document.getElementById("AgentMuteSpan").innerHTML = "<a href=\"#CHAN-" + agentchannel + "\" onclick=\"volume_control('UNMUTE','" + agentchannel + "','AgenT');return false;\"><img src=\"./images/<?php echo _QXZ("vdc_volume_UNMUTE.gif") ?>\" border=\"0\" /></a>";
                document.getElementById("AgentMuteSpan").innerHTML = "<a href=\"#CHAN-" + agentchannel + "\" onclick=\"volume_control('UNMUTE','" + agentchannel + "','AgenT');return false;\" class=\"btn btn-success\" title=\"Un Mute\"><i class='fa fa-microphone-slash'></i></a>";
				}
			else
				{
//                document.getElementById("AgentMuteSpan").innerHTML = "<a href=\"#CHAN-" + agentchannel + "\" onclick=\"volume_control('MUTING','" + agentchannel + "','AgenT');return false;\"><img src=\"./images/<?php echo _QXZ("vdc_volume_MUTE.gif") ?>\" border=\"0\" /></a>";
                document.getElementById("AgentMuteSpan").innerHTML = "<a href=\"#CHAN-" + agentchannel + "\" onclick=\"volume_control('MUTING','" + agentchannel + "','AgenT');return false;\" class=\"btn btn-success\" title=\"Mute\"><i class='fa fa-microphone'></i></a>";
				}
			}
	...
	function leave_3way_call(tempvarattempt,LTCclick)
		...
		if (customerparked > 0)
			...
			mainxfer_send_redirect('FROMParK',lastcustchannel,lastcustserverip);
                ...
                $('#xfernumber').val('');
                $('.TypeSelection').hide();
                $("#XfeRPreset option:selected").removeAttr("selected");
                $("#AgentXferViewSelect option:selected").removeAttr("selected");
                $("#XfeRGrouP option:selected").removeAttr("selected");
...
//                                                console.log(check_time_array);
              ...
              var phone_number = check_time_array[32].split("phone_number: ");
              phone_number = phone_number[1];
              var inbound_call = $('#inbound_call_phone').val();
              if(phone_number != '') {
                $('#inbound_call_phone').val(phone_number);
              }
							if (AGLogiN != 'N')
								{
							...
							if (CamPCalLs != 'N')
								...
								document.getElementById("AgentStatusCalls").innerHTML = CamPCalLs;
                                                                if(CamPCalLs > 0){
                                                                  $.toast().reset('all');
                                                                    $.toast({
                                                                           heading: 'Incoming Call Alert !!',
                                                                           //text: 'You have '+CamPCalLs+' call in queue.',
                                                                           text: 'Click <i class="fa fa-phone"></i> to receive call',
							...
							if (PausENotifYCounTer > 10)
								...
								PausENotifYCounTer=0;
                                                ...
                                                if(VLAStatuS == 'INCALL'){
                                                    ...
                                                    $('#LeadDetail-LI').show();
                                                    $('#DashboardDetailListings').hide();
                                                    $('#CallDetailListings').show();
                                                    $('#AgentMuteSpan').show();
                                                    if(DTMFKeypad == 'Y'){
                                                        $('#DTMF-Model').show();
                                                    }
...
//                                                    if($('#webIframe').attr('src')){
//
//                                                    }else{
//													//document.getElementById('webIframe').contentDocument.location.reload(true);
//													$('#webIframe')[0].contentWindow.location.reload(true);
//                                                    $('#webIframe').css('height', (screen.height + 100));
//													$('#webIframe').attr("src", URLsrc);
...
//                                                    $('#DispoModal').hide();
						...
						api_parkcustomer = APIpark_array[1];
                                                <!--console.log('TEST - '+DEADxfer+' - '+CheckDEADcallON+' - '+XD_live_customer_call);-->
...
//                                                document.getElementById("AgentMuteSpan").innerHTML = "<a href=\"#CHAN-" + agentchannel + "\" onclick=\"volume_control('MUTING','" + agentchannel + "','AgenT');return false;\"><img src=\"./images/<?php echo _QXZ("vdc_volume_MUTE.gif") ?>\" border=\"0\" /></a>";
											...
											if (agentchannel.length < 3)
                                                ...
                                                document.getElementById("AgentMuteSpan").innerHTML = "<a href=\"#CHAN-" + agentchannel + "\" onclick=\"volume_control('MUTING','" + agentchannel + "','AgenT');return false;\" class=\"btn btn-success\" title=\"Un Mute\"><i class='fa fa-microphone-slash'></i></a>";
												}
											}
		...
		if (xmlhttp)
			...
			//	filename = filedate + "_" + user_abb;
				...
				if (LIVE_campaign_recording == 'ALLFORCE')
                    ...
                    document.getElementById("RecorDControlNew").innerHTML = "";
					}
				else
					{
			...
			if (taskconfrectype == 'StopMonitorConf')
				...
				var channelrec = "Local/" + conf_silent_prefix + '' + taskconfrec + "@" + ext_context;
                var conf_rec_start_html = "<a href=\"#\" onclick=\"conf_send_recording('MonitorConf','" + taskconfrec + "','','','','YES');return false;\" class='btn btn-success'><i class='fa fa-microphone'></i></a>";
				if (LIVE_campaign_recording == 'ALLFORCE')
					{
                    document.getElementById("RecorDControl").innerHTML = "<img src=\"./images/<?php echo _QXZ("vdc_LB_startrecording_OFF.gif") ?>\" border=\"0\" alt=\"Start Recording\" />";
                    document.getElementById("RecorDControlNew").innerHTML = "";
					...
					{
					document.getElementById("RecorDControl").innerHTML = conf_rec_start_html;
					document.getElementById("RecorDControlNew").innerHTML = conf_rec_start_html;
					}
				}
			...
			//		alert(xmlhttp.responseText);
					...
					if (RClookID_array.length > 0)
						...
						if (taskconfrectype == 'MonitorConf')
							{
							var conf_rec_start_html = "<a href=\"#\" onclick=\"conf_send_recording('StopMonitorConf','" + taskconfrec + "','ID:" + recording_id + "','','','YES');return false;\" class='btn btn-danger' title='Stop Recording'><i class='fa fa-microphone-slash'></i></a>";
							if (LIVE_campaign_recording == 'ALLFORCE')
								{
								document.getElementById("RecorDControl").innerHTML = "<img src=\"./images/<?php echo _QXZ("vdc_LB_startrecording_OFF.gif") ?>\" border=\"0\" alt=\"Start Recording\" />";
								document.getElementById("RecorDControlNew").innerHTML = "";
			...
			//	conf_dialed=1;
				...
				if (xmlhttpXF)
					...
					if (taskvar == 'ParK')
						...
						$('.GrabCall').html("<a href=\"#\" onclick=\"mainxfer_send_redirect('FROMParK','" + redirectdestination + "','" + redirectdestserverip + "','','','','YES');return false;\" class=\"btn btn-default btn-app text-success AgentCallStatusBTN\"><i class=\"fa fa-pause\"></i></a>");
            $('.GrabCall1').html("<a href=\"#\" onclick=\"mainxfer_send_redirect('FROMParK','" + redirectdestination + "','" + redirectdestserverip + "','','','','YES');return false;\" class=\"btn btn-warning text-success AgentCallStatusBTN\" style='padding: 15px 5px 15px 15px;position: relative;font-weight: 400;width: 100%;color: #fff !important;text-align: center;'><i class=\"fa fa-pause\" style='width: 30px;font-size: 18px;display: inline-block;vertical-align: middle;color: #fff;padding-left: 5px;margin-right: 10px;'></i></a>");
                                                $('.PauseBTN').hide();
                                                $('.GrabCall').show();
                                                $('.GrabCall1').show();
			...
			xmlhttp.onreadystatechange = function()
				...
				//		alert("VICIDIAL Call log entered:\n" + document.vicidial_form.uniqueid.value);
						if ( (taskMDstage != "start") && (VDstop_rec_after_each_call == 1) )
							{
                            var conf_rec_start_html = "<a href=\"#\" onclick=\"conf_send_recording('MonitorConf','" + session_id + "','','','','YES');return false;\" class='btn btn-success'><i class='fa fa-microphone'></i></a>";
...
//					document.getElementById("CBstatusSpan").innerHTML = CBlinkCONTENT;
                                        ...
                                        $('#CallBackManagement').html(CBprint);
					}
				}
			delete xmlhttp;
			}
...
// Request list of USERONLY callbacks for this agent
	function CalLBacKsLisTCheck(start=0, end=0, is_popup=0)
		{
		button_click_log = button_click_log + "" + SQLdate + "-----CalLBacKsLisTCheck---|";
		var move_on=1;
		console.log('AutoDialWaiting: '+AutoDialWaiting);
		console.log('VD_live_customer_call: '+VD_live_customer_call);
		console.log('alt_dial_active: '+alt_dial_active);
		console.log('MD_channel_look: '+MD_channel_look);
		console.log('in_lead_preview_state: '+in_lead_preview_state);
		console.log('auto_pause_precall: '+auto_pause_precall);
		console.log('agent_pause_codes_active: '+agent_pause_codes_active);
...
//                        $('#CallBack-Modal').modal('show');
			...
			if (xmlhttp)
				{
				var CBlist_query = "server_ip=" + server_ip + "&session_name=" + session_name + "&user=" + user + "&pass=" + pass + "&ACTION=CalLBacKLisT&campaign=" + campaign + "&format=text&start_date=" + start +"&end_date=" + end;
				...
				xmlhttp.onreadystatechange = function()
					...
					//	alert(xmlhttp.responseText);
						...
						var CBT_HTML = '';
							...
							var CB_comments = call_array[9].replace(/%%/gmi, '<br>');
							var CB_dialable = call_array[10];
							var CB_alt_phone = call_array[11];
							var CB_new_phone = call_array[12];
                            if(CB_new_phone == '') {
                                CB_new_phone = CB_phone;
                            }
...
//                                                $('#CallBackList-listings-dashboard').dataTable( {
//  "destroy": true
//} );
$('#CallBackList-listings-dashboard').DataTable().clear().destroy();

                                                $('#CallBackList-listings-dashboard tbody').html(CBT_HTML);
                                                $('#CallBackList-listings-dashboard').DataTable();
		...
		function CalLBacKsLisTCheckPopUp(start=0, end=0)
		{
		button_click_log = button_click_log + "" + SQLdate + "-----CalLBacKsLisTCheckPopUp---|";
		var move_on=1;
		if ( (AutoDialWaiting == 1) || (VD_live_customer_call==1) || (alt_dial_active==1) || (MD_channel_look==1) || (in_lead_preview_state==1) )
			{
			if ( (auto_pause_precall == 'Y') && ( (agent_pause_codes_active=='Y') || (agent_pause_codes_active=='FORCE') ) && (AutoDialWaiting == 1) && (VD_live_customer_call!=1) && (alt_dial_active!=1) && (MD_channel_look!=1) && (in_lead_preview_state!=1) )
			...
			if (xmlhttp)
				...
				xmlhttp.onreadystatechange = function()
					...
					//	alert(xmlhttp.responseText);
						...
						var loop_ct=0;
						var conv_start=0;
                        var CB_HTML = '<table class="table">';
						CB_HTML += '<thead class="thead-light">';
						CB_HTML += '<tr><th>Lead Id</th><th>Phone Number</th><th>Callback Date</th><th>Action</th></tr>';
						CB_HTML += '</thead>';
						CB_HTML += '</tbody>';
                            while (loop_ct < CB_calls)
							{
							...
							if (CB_comments_ten.length > 10)
								...
								CB_HTML += "<tr><td>"+CB_lead_id+"</td><td>"+CB_new_phone+"</td><td>"+CB_callback_time+"</td><td><a href=\"#\" onclick=\"new_callback_call('" + CB_id + "','" + CB_lead_id + "','MAIN');return false;\" class=\"btn btn-success btn-app\"><i class=\"fa fa-phone\"></i></a></td></tr>";
							}
							CB_HTML += "</tbody>";
							CB_HTML += "</table>";
							if(all_CBs != 0) {
								$('#callBackSectionDiv').html(CB_HTML);
							} else {
								var HTML = "<div class='alert alert-info alert-dismissible'>No Callback Available</div>";
								$('#callBackSectionDiv').html(HTML);
							}
						}
					}
				delete xmlhttp;
...
//                                                        console.log(change_array);
							if (change_array[0] == '1')
								...
								custom_field_types								= change_array[50];
                                                                <!--console.log('Test1 - '+change_array);-->

                                                                var TagArray = change_array[67];
                                                                 if(TagArray){
                                                                    $('.TagList-Section').html("<span class='badge badge-dark badge-lg mt-4'>"+TagArray+"</span>");
                                                                    $('.TagSwitchBTN').addClass('active');
                                                                    $('#TagList').attr('type','text');
                                                                    $('#TagList').val(TagArray);
                                                                  }else{
                                                                    $('.TagList-Section').html("<div class='alert alert-danger mt-4'>"+
...
//                            $('#PauseCodeSwitch').removeClass('active');
//                             $('#PauseCodeSwitch').parent().find('button').html('Pause Deactivated');
					...
					//		alert("channel not found yet:\n" + campaign);
						...
						if (taskCheckOR == 'YES')
							...
							if ( (MDchannel.match(regMDL)) && (asterisk_version != '1.0.8') && (asterisk_version != '1.0.9') )
                                ...
                                document.getElementById("HoldControl").innerHTML = "<a href=\"javascript:void(0);\" class='btn btn-warning text-success AgentCallStatusBTN PauseBTN'  title='Put Lead on Hold' onclick=\"xfer_park_dial('YES');return false;\"><i class='fa fa-pause'></i></a><span class='GrabCall1' style='display:none;'></span>";
                                ...
                                document.getElementById("DialBlind").innerHTML = "<i class='fa fa-blind' onclick=\"mainxfer_send_redirect('XfeRBLIND','" + lastcustchannel + "','" + lastcustserverip + "','','','','YES');return false;\"></i>";
	...
	function ManualDialNext(mdnCBid,mdnBDleadid,mdnDiaLCodE,mdnPhonENumbeR,mdnStagE,mdVendorid,mdgroupalias,mdtype,MDNclick)
		...
		if (waiting_on_dispo > 0)
			...
			if (starting_dial_level == 0)
				...
				document.getElementById("InboundBackgroundColor").style.background = panel_bgcolor;
				reselect_alt_dial = 0;
				}
			}
		else
				...
				if (alt_phone_dialing == 1)
					{
                                        ...
                                        var StatusMan = "<a href=\"#\" onclick=\"ManualDialOnly('" + manual_dial_only_type_flag + "','YES','0')\" class='btn btn-success btn-sm'><i class='fa fa-phone'></i></a> or <a href=\"#\" onclick=\"ManualDialSkip('YES')\" class='btn btn-warning btn-sm'><i class='fa fa-clock-o'></i></a>";
					...
					if (manual_preview_dial=='PREVIEW_ONLY')
						{
                                                    var StatusMan = "<a href=\"#\" onclick=\"ManualDialOnly('" + manual_dial_only_type_flag + "','YES','0')\" class='btn btn-success btn-sm'><i class='fa fa-phone'></i></a>";
			...
			if (xmlhttp)
                ...
                console.log(MDnextResponse);
							...
							if ( (MDnextCID.match(regMNCvar)) || (MDnextCID.match(regMDFvarDNC)) || (MDnextCID.match(regMDFvarCAMP)) || (MDnextCID.match(regMDFvarTIME)) )
								...
								{
                                                                get_custom_lead_fields(MDnextResponse_array[1]);
								fronter = user;
...
//                                                                                        '<label>'+NewItem[2]+'</label><div class="input-group">'+
                ...
                document.vicidial_form.phone_number1.value		= replaced;
							...
							//	CalL_ScripT_id									= MDnextResponse_array[37];
								...
								post_phone_time_diff_alert_message				= MDnextResponse_array[50];
                                                                 var TagArray = MDnextResponse_array[62];
                                                                 if(TagArray){
                                                                    $('.TagList-Section').html("<span class='badge badge-dark badge-lg mt-4'>"+TagArray+"</span>");
                                                                    $('.TagSwitchBTN').addClass('active');
                                                                    $('#TagList').attr('type','text');
						...
						//	document.getElementById("debugbottomspan").innerHTML = VARCBstatusesLIST + '<br>' + gVARCBstatusesLIST + '|' + cVARCBstatusesLIST + '|' + gVARstatusesDETAILS[2] + '|' + MDnextResponse_array[58] + '|' + loop_gct;
								...
								document.getElementById("MainStatuSSpan").innerHTML = " <?php echo _QXZ("Calling:"); ?> " + status_display_number + " " + status_display_content + " &nbsp; " + man_status;
                                                                ...
                                                                if (typeof StatusMan === 'undefined') {

                                                                }else{

                                                                document.getElementById("PreviewDialSetting").innerHTML = StatusMan;
                                                                $('#DashboardDetailListings').hide();
                                                                $('#CallDetailListings').show();
                                                                }
				...
				xmlhttp.onreadystatechange = function()
					...
					//	alert(xmlhttp.responseText);
						...
						if (MDSnextCID == "LEAD NOT REVERTED")
							...
							{
                                                        $('#DashboardDetailListings').show();
                                                        $('#CallDetailListings').hide();
                                                        $('#CallDetail-ALL').show();
...
//                                alert(3);
                ...
                document.getElementById("CallPause").innerHTML = '<a href="javascript:void(0);" class="btn btn-danger" onclick="AutoDial_ReSume_PauSe("VDADpause","","","","","","","YES");" title="Go Pause"> <i class="fa fa-stop"></i> </a>';
...
//                                    alert(1);
				...
				auto_dial_level=starting_dial_level;
                                document.getElementById("CallPause").innerHTML = '<a href="javascript:void(0);" class="btn btn-danger" onclick="AutoDial_ReSume_PauSe("VDADready","","","","","","","YES");" title=\"Go Pause\"> <i class="fa fa-stop"></i> </a>';
//                document.getElementById("DiaLControl").innerHTML = "<a href=\"#\" onclick=\"AutoDial_ReSume_PauSe('VDADready','','','','','','','YES');\"><img src=\"./images/<?php echo _QXZ("vdc_LB_paused.gif"); ?>\" border=\"0\" alt=\"You are paused\" /></a><br><a href=\"#\" onclick=\"ManualDialNext('','','','','','0','','','YES');\"><img src=\"./images/<?php echo _QXZ("vdc_LB_dialnextnumber.gif"); ?>\" border=\"0\" alt=\"Dial Next Number\" /></a>";
				}
			else
				{
              ...
              CallCountUPtimer();
						...
						//	DialLog("start");
							...
							custom_field_types								= check_VDIC_array[50];
                                                         <!--console.log('Test3 - '+check_VDIC_array);-->
							//Added By Poundteam for Audited Comments (Manual Dial Section Only)
							if (qc_enabled > 0)
								{
							...
							last_call_date									= check_VDIC_array[66];
                                                        var TagArray = check_VDIC_array[68];
                                                                 if(TagArray){
                                                                    $('.TagList-Section').html("<span class='badge badge-dark badge-lg mt-4'>"+TagArray+"</span>");
                                                                    $('.TagSwitchBTN').addClass('active');
                                                                    $('#TagList').attr('type','text');
							...
							if (VDIC_data_VDIG[1].length > 0)
								...
								if (VDIC_data_VDIG[2].length > 2)
									...
									document.getElementById("InboundBackgroundColor").style.background = VDIC_data_VDIG[2];
									}
								var dispnum = document.vicidial_form.phone_number.value;
								var status_display_number = phone_number_format(dispnum);
								var callnum = dialed_number;
...
//                                                console.log(check_VDIC_array);
						...
						//	DialLog("start");
							...
							last_call_date									= check_VDIC_array[62];
                                                         <!--console.log('Test4 - '+check_VDIC_array);-->
                                                         var TagArray = check_VDIC_array[68];
                                                                 if(TagArray){
                                                                    $('.TagList-Section').html("<span class='badge badge-dark badge-lg mt-4'>"+TagArray+"</span>");
                                                                    $('.TagSwitchBTN').addClass('active');
...
// Send Hangup command for customer call connected to the conference now to Manager
	function dialedcall_send_hangup(dispowindow,hotkeysused,altdispo,nodeletevdac,DSHclick)
        ...
        document.getElementById("HoldControl").innerHTML = "";
	...
	function CustomerData_update()
		...
		if (xmlhttp)
			...
			"&comments=" + REGcommentsRESULT;
                        for (i = 1; i <= 50; i++) {
                             if ($('#custom_'+i).length){
                                 VLupdate_query = VLupdate_query +"&custom_"+i+"=" + encodeURIComponent($('#custom_'+i).val());
                            }
                        }
...
//			"&custom_1=" + encodeURIComponent(document.vicidial_form.custom_1.value);
			xmlhttp.open('POST', 'utg_vdc_db_query.php');
			xmlhttp.setRequestHeader('Content-Type','application/x-www-form-urlencoded; charset=UTF-8');
...
//            document.getElementById("WebFormSpan").innerHTML = "<img src=\"./images/<?php echo _QXZ("vdc_LB_webform_OFF.gif"); ?>\" border=\"0\" alt=\"Web Form\" />";
        ...
        function DispoSubmit() {
            DispoSelect_submit('','','Yes');
        }

// ################################################################################
// Update vicidial_list lead record with disposition selection
	function DispoSelect_submit(temp_use_pause_code,temp_dispo_pause_code,DSPclick,cb_submit=0)
		{
                $('.dispoBTN').addClass('btn-secondry');
                $('.dispoBTN').removeClass('btn-success');
                $('.WebFormLink').attr('link-src','');
                $('#WebformONCall iframe').removeAttr('src');
		if (DSPclick=='YES')
			{
...
//                        showDiv('LeadPanelSection')
			...
			//	alert_box("<?php echo _QXZ("You can only disposition a call once"); ?>");
				...
				if ( (VARCBstatusesLIST.match(regCBstatus)) && (DispoChoice.length > 0) && (cb_submit == 0) && (scheduled_callbacks > 0) && (DispoChoice != 'CBHOLD') )
					{
					...
					<!--showDiv('CallBackSelectBox');-->
                                        ...
                                        $('#CallDispo-Modal').modal('hide');
										$('#customer_phone').val(document.vicidial_form.phone_number.value);
...
//                                                                    Performance Detail
                                                                $.ajax({
                                                                        ...
                                                                        data: {rule: 'DashboardPerformance','VD_login':user,'VD_campaign':campaign, 'InboundGroups':InboundGroups},
                                                                        success: function (data)
                                                                        {
                                                                        var response = JSON.parse(data);
                                                                        $('.TalkDashboard').html(response.Talk);
                                                                        $('.WaitDashboard').html(response.Wait);
                                                                        $('.DispoDashboard').html(response.Dispo);
                                                                        $('.PauseDashboard').html(response.Pause);
                                                                        $('.CallDashboard').html(response.Calls);
                                                                        $('.ConnectDashboard').html(response.Connects);
                                                                        $('.DMCDashboard').html(response.DMCs);
                                                                        $('.SaleDashboard').html(response.Sales);
                                                                        $('.EmailDashboard').html(response.Email);
                                                                        $('.ChatDashboard').html(response.Chat);
                                                                        }
                                                                    });
                                                                ...
                                                                $.ajax({
                                                                        type: "POST",
                                                                        url: 'elements/ajax.php',
                                                                        data: {rule: 'Dispositions','VD_campaign':campaign},
                                                                        success: function (data)
                                                                        {
                                                                            $('#CallDispo-Modal .modal-body').html(data);
					...
					if ( (shift_logout_flag < 1) && (api_logout_flag < 1) )
						...
						if (wrapup_waiting == 0)
							{
//                                                            alert(document.vicidial_form.DispoSelectStop.checked);
...
//		showDiv('CustomerGoneBox');
                $('#CustomerGonna-Modal').modal('show');
		document.getElementById("callchannel").innerHTML = '';
		document.vicidial_form.callserverip.value = '';
		document.getElementById("CustomerGoneChanneL").innerHTML = lastcustchannel;
		document.getElementById("CustomerGoneChanneL_NEW").innerHTML = lastcustchannel;
		if( document.images ) { document.images['livecall'].src = image_livecall_OFF.src;}
		WaitingForNextStep=1;
		}
...
//                $('#modal-default').modal('hide');
                ...
                var closer_groups = $('#CloserSelectList').val();
                dashboardPerformanceDetail(closer_groups);
		MainPanelToFront();
		CloserSelecting = 0;
		scroll(0,0);
		}

    function dashboardPerformanceDetail(inbound_group) {
      $.ajax({
        type: "POST",
        url: 'elements/ajax.php',
        data: {rule: 'DashboardPerformance','VD_login':user,'VD_campaign':campaign, 'InboundGroups':inbound_group},
         success: function(data)
         {
           var response = JSON.parse(data);
           $('.TalkDashboard').html(response.Talk);
...
//                                                                console.log(newRAlocationHTML);
								...
								{
                                                                if(RAlocation == 'AgentSectionDiv'){
                                                                    document.getElementById(RAlocation).innerHTML = '<table class="table">'+newRAlocationHTML+'</table>';
                                                                }else{
                                                                    document.getElementById(RAlocation).innerHTML = newRAlocationHTML + "\n";
                                                                }
								}
				...
				if (xmlhttp)
					...
					xmlhttp.onreadystatechange = function()
						...
						//	alert(xmlhttp.responseText);
							...
							document.getElementById('callsinqueuelistNew').innerHTML = xmlhttp.responseText + "\n";
							}
						}
					delete xmlhttp;
					}
...
function CallBackDatE_submit_old() {

        button_click_log = button_click_log + "" + SQLdate + "-----CallBackDatE_submit---|";
        CallBackDatEForM = document.vicidial_form.CallBackDatESelectioN.value;
//        CallBackDatEForM = reformatDateString(CallBackDatEForM);
        CallBackCommenTs = document.vicidial_form.CallBackCommenTsField.value;
        CallBackDatETimE = CallBackDatEForM + " " + document.vicidial_form.CallBackTimESelectioN.value;
        CallBackLeadStatus = document.vicidial_form.DispoSelection.value;
...
//        CallBackCommenTs = document.vicidial_form.CallBackCommenTsField.value;
		...
		CallBackPhone = $('#customer_phone').val();
...
//        CBALTV = document.vicidial_form.CBALTV.value;
        ...
        if (CallBackDatEForM.length < 2) {
            ...
            if (document.vicidial_form.CallBackOnlyMe.checked == true || $('.AgentOnlyCallbacks').hasClass('active')) {
                CallBackrecipient = 'USERONLY';
            }
            else {
                CallBackrecipient = 'ANYONE';
...
//                                $('#modal-default').modal('hide');
			...
			if (open_dispo_screen==1)
				...
				<!--showDiv('DispoSelectBox');-->
                                var CallLength = $('#SecondSDISP').text();
                        if(CallLength > 0){
                            $('#CallCountUPTimer').html('<div class="alert alert-success mt-4"><p>  <strong> Call Length ! </strong> Your last talk time was '+CallLength+' seconds. </p></div>');
                        }else{
                        $('#CallCountUPTimer').html('');
                        }
		...
		//	document.getElementById("debugbottomspan").innerHTML = "custchannellive: " + custchannellive + " lastcustchannel.length: " + lastcustchannel.length + " no_empty_session_warnings: " + no_empty_session_warnings + " lead_id: |" + document.vicidial_form.lead_id.value + "|";
			...
			if (WaitingForNextStep==0)
				...
				if (agent_status_view_active > 0)
					...
					refresh_agents_view('AgentSectionDiv',agent_status_view);
...
//                                        console.log('HI-123-OK');
	...
	function all_refresh()
		...
		document.getElementById("TimeClock").innerHTML = '<i class="fa fa-clock-o"></i> ' + status_date + " " + status_time  + display_message;
                <!--console.log(status_date + " " + status_time  + display_message);-->
		if (VD_live_customer_call==1)
			{
			...
			if (divvar == 'DiaLLeaDPrevieW')
				...
				document.getElementById("DiaLLeaDPrevieWHide").innerHTML = '';
                                if(manual_preview_dial != 'DISABLED'){
                                    var buildDivHTML = " <input type=\"checkbox\" class=\"filled-in\" id=\"lead3\" name=\"LeadPreview\" size=\"1\" value=\"0\" checked=\"checked\" /><label for=\"lead3\"> <?php echo _QXZ("LEAD PREVIEW"); ?></label><br>";
                                }else{
...
//		document.getElementById("CallbacksButtons").style.left = '360px';
		...
		showDiv('CustomerChatPanel');
                ...
                CallCountUPtimer();
		hideDiv('LeadPanelSection');
                <!--$('#CustomerChatPanel').show();-->
                <!--$('#LeadPanelSection').hide();-->
                <!--$('#EmailPanel').hide();-->
...
setInterval(function(){
  $.ajax({
      type: "POST",
      url: 'elements/ajax.php',
      data: {rule: 'CallInbound', UserID: user}, // serializes the form's elements.
      success: function (data)
      {
        var response = JSON.parse(data);
        $('#inboundCallManagement').html(response.count);
        $('#inboundCallDiv').html(response.table);
      }
  });
}, 3000);
...
//        $.ajax({
//                   type:'POST',
//                   url: 'elements/stats.php?method=GetStats',
//                   data: {user:user}, // serializes the form's elements.
//                   success: function(data)
//                   {
//                       var result = JSON.parse(data);
...
//                       var LeaderPer = result.data.LeaderPer;
//                       var LevelUpgrade = result.data.LevelUpgrade;
//                       var Experience = result.data.Experience;
//                       var ExperiencePer = result.data.ExperiencePer;
//                       var LevelDescription = result.data.LevelDescription;
//                       $('#Level-Range').text(Level);
//                       $('#Level-Percentage').text(Percentage);
//                       $("#Level-Bar").css({"width": Percentage+"%"});
//                       $("#LeaderBoardScore").text(Points+'/'+TotalPoints);
//                       $("#LeaderBoardScoreBar").css({"width": LeaderPer+"%"});
//                       $('#LeaderExperience').text(Experience);
//                        $("#LeaderBoardEXPerformance").css({"width": ExperiencePer+"%"});
//                       if(LevelUpgrade === 1){
//                       if(LevelDescription){
//                        $('.LevelDescription').text(LevelDescription);
//                       }else{
//                       $('.LevelDescription').text('HERO');
//                                            }
//                       $('#alerttopright').show();
//                       setTimeout(function(){ $('#alerttopright').hide(); }, 40000);
//                       }
//                   }
//                 });
//}, 3000);
...
function CustomerCallHistory(){
var LeadID = $('#lead_id').val();
$.ajax({
    type:'POST',
    url: 'elements/ajax.php',
    data: {rule:'CustomerCallHistory',LeadID:LeadID,campaign:campaign},
    success: function(data)
    {
    $('#CustomerHistoryListings').html(data);
    $('#CustomerCallHistroyDetail').DataTable();
    }
  });
...
function VieWLeaDInfO_UTG(VLI_lead_id,VLI_cb_id,VLI_inbound_lead_search)
		{
		button_click_log = button_click_log + "" + SQLdate + "-----VieWLeaDInfO---" + VLI_lead_id + " " + VLI_cb_id + " " + VLI_inbound_lead_search + "|";
//		showDiv('LeaDInfOBox');
		...
		if (xmlhttp)
			{
			RAview_query = "server_ip=" + server_ip + "&session_name=" + session_name + "&ACTION=LEADINFOview&format=text&user=" + user + "&pass=" + pass + "&conf_exten=" + session_id + "&extension=" + extension + "&protocol=" + protocol + "&lead_id=" + VLI_lead_id + "&disable_alter_custphone=" + disable_alter_custphone + "&campaign=" + campaign + "&callback_id=" + VLI_cb_id + "&inbound_lead_search=" + VLI_inbound_lead_search + "&manual_dial_filter=" + agentcall_manual + "&stage=<?php echo $HCwidth ?>";
			xmlhttp.open('POST', 'utg_ajax.php');
			xmlhttp.setRequestHeader('Content-Type','application/x-www-form-urlencoded; charset=UTF-8');
			xmlhttp.send(RAview_query);
			xmlhttp.onreadystatechange = function()
				{
				if (xmlhttp.readyState == 4 && xmlhttp.status == 200)
					{
                                            ...
                                            $('#LeadInformation').modal('show');
                                            $('#CustomerInformationPanelSection').html(Result.LeadDetail);
                                            $('#CallLogPanelSection').html(Result.CallLog);
                                            $('#EmailLogPanelSection').html(Result.EmailLog);
				//	alert(xmlhttp.responseText);
//					document.getElementById('LeaDInfOSpan').innerHTML = xmlhttp.responseText + "\n";
					}
				}
			delete xmlhttp;
                ...
                setTimeout(function(){ CalLBacKsCounTCheck(); }, 10000);
