...
#	echo "		alert('new list:'+ temp_new_list_id);\n";
	...
	$CFoutput = custom_list_fields_values_NEW($lead_id,$list_id,$uniqueid,$user,$DB,$call_id,$did_id,$did_extension,$did_pattern,$did_description,$dialed_number,$dialed_label);
