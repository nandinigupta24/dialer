...
$rslt=mysql_to_mysqli($stmt, $link);
        if (isset($mel) && $mel > 0) {mysql_error_logging($NOW_TIME,$link,$mel,$stmt,'00XXX',$user,$server_ip,$session_name,$one_mysql_log);}
...
$ChatGroup = $database->query("SELECT VIG.group_color,VLC.group_id,CONCAT(VL.first_name,' ',VL.last_name) as name,VL.phone_number,VL.email,VL.lead_id FROM vicidial_live_chats VLC
JOIN
vicidial_inbound_groups VIG
ON
VIG.group_id=VLC.group_id
JOIN vicidial_list VL
ON
VL.lead_id = VLC.lead_id
WHERE
VLC.chat_id = ".$chat_id)->fetchALL(PDO::FETCH_ASSOC);
...
<link href="../assets/chat//main.87c0748b313a1dda75f5.css" rel="stylesheet">
     ...
     <div class="app-main__outer">
            <div class="app-main__inner p-0">
                <div class="app-inner-layout chat-layout">
                    <div class="app-inner-layout__header text-white" style="background-color:<?php echo $ChatGroup[0]['group_color']; ?>">
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions" style="display:none;">
                                    <button type="button" onClick="EndChat();" data-toggle="tooltip" title="" data-placement="bottom" class="btn-shadow mr-3 btn btn-danger" data-original-title="Example Tooltip">
                            ...
                            <div class="table-responsive">
                                <div class="app-inner-layout__top-pane">
                                    <div class="pane-left">
                                        ...
                                        <div class="avatar-icon-wrapper mr-2">
                                            ...
                                            <div class="avatar-icon avatar-icon-xl rounded"><img width="82" src="../assets/chat/images/avatars/1.jpg" alt=""></div>
                                        </div>
                                        <h4 class="mb-0 text-nowrap"><?php echo $ChatGroup[0]['name']; ?>
                                            <div class="opacity-7">Last Seen Online: <span class="opacity-8">10 minutes ago</span></div>
                                        </h4>
                                    </div>
                                    <div class="pane-right">
                                        <button type="button" onClick="EndChat();" data-toggle="tooltip" title="" data-placement="bottom" class="btn btn-danger btn-app mr-3" data-original-title="Chat Closed">
                                            <i class="fa fa-power-off"></i>
                                        </button>
                                        <button type="button" data-toggle="tooltip" title="" data-placement="bottom" class="btn btn-success mr-3" data-original-title="Privacy ON">
                                            <i class="fa fa-user-lock"></i>
                                        </button>
                                        <button type="button" data-toggle="tooltip" title="" data-placement="bottom" class="btn btn-warning mr-3 AlertSound" data-original-title="Mute Alert Sound">
                                            <i class="fa fa-volume-mute"></i>
                                        </button>
                                    </div>
                                </div>
                                <div class="chat-wrapper" id="ChatDisplayNew">
                                ...
                                <div class="app-inner-layout__bottom-pane d-block text-center">
                                    <div class="mb-0 position-relative row form-group">
                                        <div class="col-sm-12">
                                            <input placeholder="Write here and hit enter to send..." type="text" name='chat_message' id='chat_message' class="form-control-lg form-control chat_window" onkeypress="if (event.keyCode==13 && !event.shiftKey) {SendMessage(this.form.chat_id.value, this.form.user.value, this.form.chat_message.value); return false;}"/>
                                        </div>
                                    </div>
                                </div>
...
<!--                                    <li class="pt-4 pl-3 pr-3 pb-3 nav-item">
                                    ...
                                    <li class="nav-item-header nav-item">Customers Online</li>
                                </ul>
                            </div>
                            <ul class="nav flex-column">
                                <?php
                                $query = "SELECT CONCAT(VL.first_name,' ',VL.last_name) as name,VL.phone_number,VL.email,VL.lead_id FROM vicidial_live_chats VLC
JOIN
vicidial_inbound_groups VIG
ON
VIG.group_id=VLC.group_id
...
VL.lead_id = VLC.lead_id
WHERE
VLC.chat_id != ".$chat_id." AND VLC.group_id ='".$ChatGroup[0]['group_id']."'";

                                $CurrentCustomer = $database->query($query)->fetchALL(PDO::FETCH_ASSOC);
                                ?>

                                <?php foreach($CurrentCustomer as $CustomerCurrent){?>
                                <li class="nav-item">
                                                ...
                                                <div class="widget-content-left mr-3">
                                                    <div class="avatar-icon-wrapper">
                                                        ...
                                                        <div class="avatar-icon"><img
                                                                src="../assets/chat/images/customer.png"
                                                                alt=""></div>
                                                    </div>
                                                </div>
                                                <div class="widget-content-left">
                                                    <div class="widget-heading"><?php echo $CustomerCurrent['name'];?></div>
                                                    <div class="widget-subheading"><?php echo $CustomerCurrent['phone_number'];?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </button>
                            ...
                            <div class="app-inner-layout__sidebar-footer pb-3">
                                <ul class="nav flex-column">
                                    <ul class="nav flex-column">
                                        <li class="nav-item-header nav-item">Customer Information</li>
                                        <li class="nav-item">
                                            <a href="javascript:void(0);" class="nav-link"><i class="nav-link-icon pe-7s-phone"> </i><span>Phone</span>
                                            <div class="ml-auto badge badge-pill badge-info"><?php echo $ChatGroup[0]['phone_number'];?></div>
                                            </a>
                                        </li>
                                        <li class="nav-item"><a href="javascript:void(0);" class="nav-link"><i class="nav-link-icon pe-7s-config"> </i><span>IP</span>
                                            <div class="ml-auto badge badge-success"><?php echo $ChatGroup[0]['email'];?></div>
                                        </a></li>
                                        <li class="nav-item"><a href="javascript:void(0);" class="nav-link"><i class="nav-link-icon pe-7s-id"> </i><span>Lead ID</span>
                                            <div class="ml-auto badge badge-warning"><?php echo $ChatGroup[0]['lead_id'];?></div>
                                        </a></li>
                                    </ul>
                                </ul>
                            </div>
              ...
              <div class="col-md-12">
                <div class="bottom">
                  <!--<form class="text-area">-->
                    ...
                    <textarea class="form-control chat_window" name='chat_message_OLD' id='chat_message_OLD' placeholder="Start typing for reply..." rows="1" onkeypress="if (event.keyCode==13 && !event.shiftKey) {SendMessage(this.form.chat_id.value, this.form.user.value, this.form.chat_message.value); return false;}"></textarea>
...
<!--<script type="text/javascript" src="../assets/chat/scripts/main.87c0748b313a1dda75f5.js"></script>-->
<script>
