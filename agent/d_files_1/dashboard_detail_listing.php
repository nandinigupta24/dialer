    ...
    <section class="content">
        ...
        <div class="tab-content">
                                        ...
                                        <div>
                                            ...
                                            <a href="#">
                                                <p>
                                                    ...
                                                    Experience
                                                    <small class="pull-right">0/50</small>
                                                </p>
                                                <div class="progress xs">
                                        ...
                                        <div>
                                            ...
                                            <a href="#">
                                                <p>
                                                    ...
                                                    Leaderboard
                                                    <small class="pull-right">0/0</small>
                                                </p>
                                                <div class="progress xs">
            ...
            <div class="tab-pane" id="callhistory" role="tabpanel"> 
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-list"></i> Call History</h3>

                        <div class="box-controls pull-right"> 
                            <button type="button" class="btn btn-success" id="daterange-btn"style="margin-top:-19px;">
                                <span>
            ...
            <div class="tab-pane" id="callbacks" role="tabpanel">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-list"></i> Callbacks</h3>
