...
<span style="position:absolute;left:0px;top:0px;z-index:<?php $zi++;echo $zi ?>;width:100%;height:100%;background-color:#e9e9e9;visibility:hidden;display:none;" id="DispoSelectBox">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <button type="button" class="btn btn-md btn-toggle btn-info AgentOnlyCallbacks" data-toggle="button" aria-pressed="true" autocomplete="off">
    ...
    <div class="modal-dialog modal-lg">
          <div class="modal-content">
			...
			<span type="button" class="btn btn-medium btn-toggle TagSwitchBTN" data-toggle="button" aria-pressed="true" autocomplete="off">
                            ...
                            <br/><br/>
                            <input type="hidden" name="tag" value="" class="form-control" placeholder="Tag"/>
                        </div>
			<div class="col-4">
			<p align="right">
    ...
    <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="modal-footer modal-footer-uniform">
                   <button type="button" class="btn btn-danger btn-app" data-dismiss="modal">Close</button>
                   <button type="button" class="btn btn-success btn-app float-right" onclick="CustomerGoneHangup();return false;"><?php echo _QXZ("Finish and Disposition Call"); ?></button>
            </div>
          </div>
    </div>
</div>
