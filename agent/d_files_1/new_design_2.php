...
<!--        <div class="page-loader-wrapper" style="display: block;" id="LoadingBox">
        ...
        <ul class="nav navbar-nav">		
          ...
          <li class="dropdown messages-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" onclick="CalLBacKsLisTCheck();return false;">
            ...
            <ul class="dropdown-menu scale-up">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <a href="javascript:void(0);" class="btn btn-danger btn-sm btn-rounded" onclick="alert('Please wait....');">View Profile</a>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
                <div class="row no-gutters">
                    <?php
                        $VARpause_codes1 = array_filter(explode("','", rtrim(ltrim($VARpause_codes, "'"), "'")));
...
?>
                                            ...
                                            <div class="card " style="z-index:<?php $zi++;
                                                echo $zi ?>;display:none;" id="ViewCommentsBox">
                                                <div class="header">
                 ...
                 <div class="card" style="z-index:<?php $zi++;
                                                echo $zi ?>;display:none;"  id="AgentStatusSpan">
                        <div class="header">
				            <h2>Agent Status</h2>
				        </div>
				         <div class="body">
                 ...
                 <div class="card" style="z-index:<?php $zi++;
                                            echo $zi ?>;top:-382px;display:none;" id="HotKeyEntriesBox">
                ...
                <div class="card" style="z-index:<?php $zi++;
                                                    echo $zi ?>;top:-655px;display:none;" id="CBcommentsBox">
...
//				agent_log_id = AutoDial_ReSume_PauSe("VDADpause",'','','','','1','');
                ...
                if (move_on == 1) {
                    if ($(this).hasClass('active')) {
                        ...
                        $('.DispoSelectStop-NEW').attr('checked','');
                    }
                }
...
//    generate_presets_pulldown('YES');
            ...
            function CallCountUPtimer() {
                $('#CallCountUPTimer').html('<div id="countup"></div>');
