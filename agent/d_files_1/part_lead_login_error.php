                    ...
                    <div class="row align-items-center justify-content-md-center h-p100">
                        <div class="col-lg-4 col-md-12 col-12">
                            <?php if (!empty($VDdisplayMESSAGE) && $VDdisplayMESSAGE) { ?>
                                    <div class="alert alert-danger"><?php echo $VDdisplayMESSAGE; ?></div>
                                <?php } ?>
                            <div class="login-box">
...
<!--                                                <span id="LogiNReseT">
                                                ...
                                                <h4 style="margin-top:10px;">Logged in as <strong class="text-blue"><?php echo $_SESSION['CurrentLogin']['full_name']; ?></strong> <a href="/utgone/logout" class="text-warning ml-5">Log Out</a></h4>
