...
//		echo "<TABLE CELLPADDING=0 CELLSPACING=1><TR><TD VALIGN=TOP><TABLE CELLPADDING=0 CELLSPACING=1>";
		...
		while ($j > $k)
			...
			$i = $order_split[1];
                        echo '<option value="'.$AXVSuser[$i].'" style="background-color:'.$AXVSstatuscolor[$i].';">'.$AXVSuser[$i].'-'.$AXVSfull_name[$i].'</option>';
...
//		echo "<CENTER>\n";
		...
		$INFOout .= "<table class='table table-striped' style='color:inherit;'>";
		...
		if ($info_to_print > 0)
			...
			$INFOout .= "<tr><th>"._QXZ("Status:")." &nbsp; </th><td>$row[0]</td></tr>";
...
//				{$NOTESout .= "<CENTER>"._QXZ("CALL LOG FOR THIS LEAD:")."<br>\n";}
			$NOTESout .= "<table class='table table-bordered' style='color:inherit;'>";
...
//			$NOTESout .= "<CENTER>"._QXZ("EMAIL LOG FOR THIS LEAD:")."<br>\n";
			$NOTESout1 .= "<table class='table table-bordered' style='color:inherit;'>";
			$NOTESout1 .= "<thead class='bg-success'><tr>";
			$NOTESout1 .= "<th>#</th>";
			$NOTESout1 .= "<th>"._QXZ("DATE/TIME")."</th>";
			$NOTESout1 .= "<th>"._QXZ("AGENT")." </th>";
			$NOTESout1 .= "<th>"._QXZ("CAMPAIGN")." </th>";
			$NOTESout1 .= "<th>"._QXZ("EMAIL TO")."</th>";
			$NOTESout1 .= "<th>"._QXZ("ATTACHMENTS")."</th>";
			$NOTESout1 .= "</tr></thead><tbody>";
			...
			while ($logs_to_print > $u)
				...
				$NOTESout1 .= "<tr>";
				$NOTESout1 .= "<td><font size=1>$u</td>";
				$NOTESout1 .= "<td align=left><font class='sb_text'> &nbsp; $row[3]</td>";
				$NOTESout1 .= "<td align=left><font class='sb_text'> &nbsp; $row[4] </td>\n";
				$NOTESout1 .= "<td align=left><font class='sb_text'> &nbsp; $row[7]</td>\n";
				$NOTESout1 .= "<td align=left><font class='sb_text'> &nbsp; $row[5]</td>\n";
				$NOTESout1 .= "<td align=left><font size=1> &nbsp; $row[8] </td>\n";
				$NOTESout1 .= "</tr>\n";
				$NOTESout1 .= "<tr>";
				$NOTESout1 .= "<td><font size=1> &nbsp; </td>\n";
				$NOTESout1 .= "<td align=left colspan=5 $bgcolor><font size=1> "._QXZ("MESSAGE:")." $row[6] </td>\n";
				$NOTESout1 .= "</tr>\n";
				}

			$NOTESout1 .= "</tbody></table>";
			}
		### END Email Log ##
		...
		if ($search == 'logfirst')
			{echo "$NOTESout\n$INFOout\n";}
                    ...
                    echo json_encode(['LeadDetail'=>$INFOout,'CallLog'=>$NOTESout,'EmailLog'=>$NOTESout1]);
                        exit;
                        }
